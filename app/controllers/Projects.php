...
class Projects extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \SeeGap\Filters([], ['name'], ['project_id', 'last_datetime', 'name', 'datetime']));
        ...
        $paginator = (new \SeeGap\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('projects?' . $filters->get_get() . '&page=%d')));
        ...
        $view = new \SeeGap\View('projects/index', (array) $this);
        ...
        if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
            ...
            switch($_POST['type']) {
                case 'delete':
                    ...
                    /* Team checks */
                    if(\SeeGap\Teams::is_delegated() && !\SeeGap\Teams::has_access('delete.projects')) {
