...
/**
 * YouTube Block Handler
 * 
 * Handles the creation and updating of YouTube microsite blocks.
 */
class YoutubeBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['youtube_video_id'] = mb_substr(query_clean($_POST['youtube_video_id']), 0, 32);
    ...
    public function update($type) {
        ...
        $required_fields = ['youtube_video_id'];
