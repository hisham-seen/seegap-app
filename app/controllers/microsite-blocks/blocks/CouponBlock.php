...
/**
 * Coupon Block Handler
 * 
 * Handles the creation and updating of coupon microsite blocks.
 */
class CouponBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['coupon_code'] = mb_substr(query_clean($_POST['coupon_code']), 0, 32);
    ...
    public function update($type) {
        ...
        $required_fields = ['title', 'coupon_code'];
