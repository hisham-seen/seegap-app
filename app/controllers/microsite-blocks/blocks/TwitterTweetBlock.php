...
/**
 * Twitter Tweet Block Handler
 * 
 * Handles the creation and updating of Twitter tweet microsite blocks.
 */
class TwitterTweetBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['twitter_tweet_url'] = get_url($_POST['twitter_tweet_url']);
        ...
        $settings = json_encode([
            'twitter_tweet_url' => $_POST['twitter_tweet_url'],
    ...
    public function update($type) {
        ...
        $required_fields = ['twitter_tweet_url'];
