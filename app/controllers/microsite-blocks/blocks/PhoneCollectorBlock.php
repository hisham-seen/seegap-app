...
/**
 * Phone Collector Block Handler
 * 
 * Handles the creation and updating of phone collector microsite blocks.
 */
class PhoneCollectorBlock extends BaseBlockHandler {
    
    public function getSupportedTypes() {
        return ['phone_collector'];
    }
