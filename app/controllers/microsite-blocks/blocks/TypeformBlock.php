...
/**
 * Typeform Block Handler
 * 
 * Handles the creation and updating of Typeform microsite blocks.
 */
class TypeformBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['typeform_url'] = get_url($_POST['typeform_url']);
        ...
        $settings = json_encode([
            'typeform_url' => $_POST['typeform_url'],
