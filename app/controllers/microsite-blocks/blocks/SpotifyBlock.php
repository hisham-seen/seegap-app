...
/**
 * Spotify Block Handler
 * 
 * Handles the creation and updating of Spotify microsite blocks.
 */
class SpotifyBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['spotify_url'] = get_url($_POST['spotify_url']);
