...
/**
 * Twitter Profile Block Handler
 * 
 * Handles the creation and updating of Twitter profile microsite blocks.
 */
class TwitterProfileBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['twitter_profile_url'] = get_url($_POST['twitter_profile_url']);
        ...
        $settings = json_encode([
            'twitter_profile_url' => $_POST['twitter_profile_url'],
    ...
    public function update($type) {
        ...
        $required_fields = ['twitter_profile_url'];
