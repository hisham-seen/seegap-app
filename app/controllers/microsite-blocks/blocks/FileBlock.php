 ...
 * File Block Handler
 * 
 * Handles the creation and updating of file microsite blocks.
 */
class FileBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        /* File upload */
        $db_file = $this->handle_file_upload(null, 'files/', settings()->links->file_size_limit);
    ...
    public function update($type) {
        ...
        /* File upload */
        $db_file = $this->handle_file_upload($microsite_block->settings->file, 'files/', settings()->links->file_size_limit);
