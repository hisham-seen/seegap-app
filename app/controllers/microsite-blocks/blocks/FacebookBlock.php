...
/**
 * Facebook Block Handler
 * 
 * Handles the creation and updating of Facebook microsite blocks.
 */
class FacebookBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['facebook_url'] = get_url($_POST['facebook_url']);
