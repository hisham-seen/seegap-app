...
/**
 * Discord Block Handler
 * 
 * Handles the creation and updating of Discord microsite blocks.
 */
class DiscordBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['discord_server_id'] = mb_substr(query_clean($_POST['discord_server_id']), 0, 32);
    ...
    public function update($type) {
        ...
        $required_fields = ['discord_server_id'];
