...
/**
 * Twitter Video Block Handler
 * 
 * Handles the creation and updating of Twitter video microsite blocks.
 */
class TwitterVideoBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['twitter_video_url'] = get_url($_POST['twitter_video_url']);
        ...
        $settings = json_encode([
            'twitter_video_url' => $_POST['twitter_video_url'],
    ...
    public function update($type) {
        ...
        $required_fields = ['twitter_video_url'];
