...
/**
 * Mixcloud Block Handler
 * 
 * Handles the creation and updating of Mixcloud microsite blocks.
 */
class MixcloudBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['mixcloud_url'] = get_url($_POST['mixcloud_url']);
        ...
        $settings = json_encode([
            'mixcloud_url' => $_POST['mixcloud_url'],
