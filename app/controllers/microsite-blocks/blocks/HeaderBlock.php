 ...
 * 
 * Handles the creation and updating of header microsite blocks.
 */
class HeaderBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['text'] = mb_substr(input_clean($_POST['text']), 0, 256);
