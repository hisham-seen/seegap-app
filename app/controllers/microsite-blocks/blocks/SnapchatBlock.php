...
/**
 * Snapchat Block Handler
 * 
 * Handles the creation and updating of Snapchat microsite blocks.
 */
class SnapchatBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['snapchat_url'] = get_url($_POST['snapchat_url']);
