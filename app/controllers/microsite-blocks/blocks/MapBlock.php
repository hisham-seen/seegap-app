 ...
 * Map Block Handler
 * 
 * Handles the creation and updating of map microsite blocks.
 */
class MapBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['address'] = mb_substr(query_clean($_POST['address']), 0, 256);
    ...
    public function update($type) {
        ...
        $_POST['map_type'] = in_array($_POST['map_type'], ['roadmap', 'satellite', 'hybrid', 'terrain']) ? query_clean($_POST['map_type']) : 'roadmap';
