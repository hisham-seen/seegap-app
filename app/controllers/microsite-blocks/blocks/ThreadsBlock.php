...
/**
 * Threads Block Handler
 * 
 * Handles the creation and updating of Threads microsite blocks.
 */
class ThreadsBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['threads_url'] = get_url($_POST['threads_url']);
