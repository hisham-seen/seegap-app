...
/**
 * TikTok Video Block Handler
 * 
 * Handles the creation and updating of TikTok video microsite blocks.
 */
class TiktokVideoBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['tiktok_video_url'] = get_url($_POST['tiktok_video_url']);
        ...
        $settings = json_encode([
            'tiktok_video_url' => $_POST['tiktok_video_url'],
    ...
    public function update($type) {
        ...
        $required_fields = ['tiktok_video_url'];
