 ...
 * Vimeo Block Handler
 * 
 * Handles the creation and updating of Vimeo microsite blocks.
 */
class VimeoBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['vimeo_video_id'] = mb_substr(query_clean($_POST['vimeo_video_id']), 0, 32);
    ...
    public function update($type) {
        ...
        $required_fields = ['vimeo_video_id'];
