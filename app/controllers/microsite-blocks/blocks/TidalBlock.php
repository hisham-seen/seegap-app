 ...
 * Tidal Block Handler
 * 
 * Handles the creation and updating of Tidal music microsite blocks.
 */
class TidalBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['tidal_url'] = get_url($_POST['tidal_url']);
