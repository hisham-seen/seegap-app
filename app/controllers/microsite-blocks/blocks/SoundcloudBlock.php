...
/**
 * SoundCloud Block Handler
 * 
 * Handles the creation and updating of SoundCloud microsite blocks.
 */
class SoundcloudBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['soundcloud_url'] = get_url($_POST['soundcloud_url']);
    ...
    public function update($type) {
        ...
        $required_fields = ['soundcloud_url'];
