 ...
 * Kick Block Handler
 * 
 * Handles the creation and updating of Kick streaming microsite blocks.
 */
class KickBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['kick_url'] = get_url($_POST['kick_url']);
