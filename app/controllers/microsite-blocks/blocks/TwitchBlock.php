...
/**
 * Twitch Block Handler
 * 
 * Handles the creation and updating of Twitch microsite blocks.
 */
class TwitchBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['twitch_url'] = get_url($_POST['twitch_url']);
