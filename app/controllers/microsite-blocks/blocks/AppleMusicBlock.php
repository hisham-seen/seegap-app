...
/**
 * Apple Music Block Handler
 * 
 * Handles the creation and updating of Apple Music microsite blocks.
 */
class AppleMusicBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['apple_music_url'] = get_url($_POST['apple_music_url']);
        ...
        $settings = json_encode([
            'apple_music_url' => $_POST['apple_music_url'],
    ...
    public function update($type) {
        ...
        $required_fields = ['apple_music_url'];
