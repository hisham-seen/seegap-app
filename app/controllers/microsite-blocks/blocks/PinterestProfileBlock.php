...
/**
 * Pinterest Profile Block Handler
 * 
 * Handles the creation and updating of Pinterest profile microsite blocks.
 */
class PinterestProfileBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['pinterest_profile_url'] = get_url($_POST['pinterest_profile_url']);
        ...
        $settings = json_encode([
            'pinterest_profile_url' => $_POST['pinterest_profile_url'],
    ...
    public function update($type) {
        ...
        $required_fields = ['pinterest_profile_url'];
