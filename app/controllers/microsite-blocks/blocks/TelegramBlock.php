...
/**
 * Telegram Block Handler
 * 
 * Handles the creation and updating of Telegram microsite blocks.
 */
class TelegramBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['telegram_url'] = get_url($_POST['telegram_url']);
