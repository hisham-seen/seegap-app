 ...
 * 
 * Handles the creation and updating of markdown microsite blocks.
 */
class MarkdownBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['markdown'] = mb_substr($_POST['markdown'], 0, 8192);
