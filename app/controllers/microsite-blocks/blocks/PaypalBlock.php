...
/**
 * PayPal Block Handler
 * 
 * Handles the creation and updating of PayPal microsite blocks.
 */
class PaypalBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['paypal_email'] = mb_substr(filter_var($_POST['paypal_email'], FILTER_SANITIZE_EMAIL), 0, 320);
    ...
    public function update($type) {
        ...
        $required_fields = ['paypal_email', 'name', 'price', 'currency'];
