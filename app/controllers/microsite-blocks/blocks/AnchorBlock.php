...
/**
 * Anchor Block Handler
 * 
 * Handles the creation and updating of Anchor podcast microsite blocks.
 */
class AnchorBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        $_POST['anchor_url'] = get_url($_POST['anchor_url']);
