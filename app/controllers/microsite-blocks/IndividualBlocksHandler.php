...
class IndividualBlocksHandler extends BaseBlockHandler {
    ...
    public function create($type) {
        $method_name = 'create_microsite_' . $type;
    ...
    public function update($type) {
        $method_name = 'update_microsite_' . $type;
    ...
    // Each block type follows the same structure: create_microsite_[type]() and update_microsite_[type]()
}
