...
class AdminProjects extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \SeeGap\Filters(['user_id'], ['name'], ['project_id', 'last_datetime', 'datetime', 'name']));
        ...
        $paginator = (new \SeeGap\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('admin/projects?' . $filters->get_get() . '&page=%d')));
        ...
        $view = new \SeeGap\View('admin/projects/index', (array) $this);
