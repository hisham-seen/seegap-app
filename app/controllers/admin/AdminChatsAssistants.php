...
use SeeGap\Alerts;
use SeeGap\Models\ChatsAssistants;
...
class AdminChatsAssistants extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \SeeGap\Filters([], ['name'], ['chat_assistant_id', 'datetime', 'name', 'total_usage']));
        ...
        $paginator = (new \SeeGap\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('admin/chats-assistants?' . $filters->get_get() . '&page=%d')));
        ...
        $view = new \SeeGap\View('admin/chats-assistants/index', (array) $this);
