...
class AdminImages extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \SeeGap\Filters(['user_id', 'project_id', 'size', 'artist', 'lighting', 'style', 'mood', 'api'], ['name'], ['image_id', 'last_datetime', 'datetime', 'name']));
        ...
        $paginator = (new \SeeGap\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('admin/images?' . $filters->get_get() . '&page=%d')));
        ...
        $view = new \SeeGap\View('admin/images/index', (array) $this);
