...
class Chats extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \SeeGap\Filters(['user_id'], ['name'], ['chat_id', 'last_datetime', 'datetime', 'name', 'total_comments', 'used_tokens']));
        ...
        $paginator = (new \SeeGap\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('chats?' . $filters->get_get() . '&page=%d')));
        ...
        $view = new \SeeGap\View(\SeeGap\Plugin::get('aix')->path . 'views/chats/index', (array) $this, true);
    ...
    public function delete() {
        ...
        /* Team checks */
        if(\SeeGap\Teams::is_delegated() && !\SeeGap\Teams::has_access('delete.chats')) {
        ...
        if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
            ...
            /* Delete the resource */
            (new \SeeGap\Models\Chats())->delete($chat_id);
