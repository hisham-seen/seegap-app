 ...
 * Base Block Handler
 * 
 * Provides shared functionality for all biolink block handlers.
 */
abstract class BaseBlockHandler implements Interfaces\BlockHandlerInterface {
    ...
    /**
     * Process biolink theme settings
     */
    protected function process_biolink_theme_id_settings($link, $settings, $type) {
