 ...
 * 
 * Handles the creation and updating of PDF document biolink blocks.
 */
class PdfDocumentBlock extends BaseBlockHandler {
    ...
    public function update($type) {
        ...
        /* File upload */
        $db_file = $this->handle_file_upload($biolink_block->settings->file, 'files/', settings()->links->file_size_limit, ['pdf']);
