 ...
 * 
 * Handles the creation and updating of PowerPoint presentation biolink blocks.
 */
class PowerpointPresentationBlock extends BaseBlockHandler {
    ...
    public function create($type) {
        ...
        /* File upload */
        $db_file = $this->handle_file_upload(null, 'files/', settings()->links->file_size_limit, ['ppt', 'pptx']);
    ...
    public function update($type) {
        ...
        /* File upload */
        $db_file = $this->handle_file_upload($biolink_block->settings->file, 'files/', settings()->links->file_size_limit, ['ppt', 'pptx']);
