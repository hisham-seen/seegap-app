 ...
 * 
 * Handles the creation and updating of review biolink blocks.
 */
class ReviewBlock extends BaseBlockHandler {
    ...
    public function update($type) {
        ...
        /* Image upload */
        $db_image = $this->handle_image_upload($biolink_block->settings->reviewer_image, 'block_thumbnail_images/', settings()->links->thumbnail_image_size_limit);
