 ...
 * Audio Block Handler
 * 
 * Handles the creation and updating of audio biolink blocks.
 */
class AudioBlock extends BaseBlockHandler {
    ...
    public function update($type) {
        ...
        /* File upload */
        $db_file = $this->handle_file_upload($biolink_block->settings->file, 'files/', settings()->links->file_size_limit, 'audio');
