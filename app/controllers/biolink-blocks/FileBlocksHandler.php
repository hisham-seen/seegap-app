...
/**
 * Handler for file-based biolink blocks
 * 
...
class FileBlocksHandler extends BaseBlockHandler {
    ...
    public function update($type) {
        $this->update_biolink_file($type);
    }
    
    /**
     * Create a file-based biolink block
     * 
    ...
    /**
     * Update a file-based biolink block
     * 
     * @param string $type The file block type
     * @return void
     */
