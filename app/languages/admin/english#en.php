...
return [
    ...
    'admin_plans.plan.microsite_blocks_limit' => 'Microsite blocks per microsite page limit',
    ...
    'admin_plans.plan.microsites_limit' => 'Microsites Limit',
    'admin_plans.plan.microsites_limit_help' => 'The total amount of microsite pages that a user can create. Set -1 for unlimited.',
    ...
    'admin_plans.plan.microsites_templates' => 'Microsites templates',
    'admin_plans.plan.microsites_themes' => 'Microsites themes',
    ...
    'admin_plans.plan.custom_branding_help' => 'This gives the option for people to add their custom branding for the microsites footer.',
    ...
    'admin_plans.plan.seo_help' => 'Gives the user the ability to change the Title and Meta Description of Microsite pages.',
    ...
    'admin_plans.plan.socials_help' => 'Gives the user the ability to add his social media accounts and be displayed below the microsite links.',
    ...
    'admin_plans.plan.leap_link_help' => 'Gives the user the ability to temporarily redirect microsite pages to a particular URL.',
    'admin_plans.plan.dofollow_is_enabled' => 'Dofollow microsite links',
    'admin_plans.plan.dofollow_is_enabled_help' => 'The user microsite links will have the dofollow property, otherwise it is set to nofollow by default.',
    'admin_plans.plan.custom_pwa_is_enabled' => 'Custom microsite page PWA',
    'admin_plans.plan.custom_pwa_is_enabled_help' => 'The user microsite pages will be able to have their own customizable PWA app.',
    'admin_plans.plan.enabled_microsite_blocks' => 'Enabled microsite blocks',
    ...
    'admin_index.microsite_links' => 'Microsite pages',
    ...
    'admin_settings.captcha.microsite_is_enabled' => 'Enable captcha on the microsite pages for blocks',
   ...
   'admin_settings.facebook.tab' => 'Facebook login',
    ...
    'admin_settings.custom.head_js_microsite' => 'Microsite page custom JS',
    'admin_settings.custom.head_css_microsite' => 'Microsite page custom CSS',
    'admin_settings.custom.body_content_microsite' => 'Microsite page body content',
    ...
    'admin_settings.image_optimizer.provider.imagerypro' => 'SeeGap Imagery Pro',
    'admin_settings.image_optimizer.provider.imagerypro_help' => 'Service provided by SeeGap. Works with JPG, PNG, SVG, GIF, AVIF, WEBP files up to 20MB.',
    'admin_settings.image_optimizer.provider.imagerypro_help2' => 'Subscribe to any <a href="https://Seegap.com/subscribe-club" target="_blank">SeeGap Club</a> subscriptions to get access.',
    'admin_settings.image_optimizer.imagerypro_api_key' => 'API key',
    'admin_settings.image_optimizer.imagerypro_api_key_help' => 'License key from your active SeeGap Club subscription.',
    ...
    'admin_settings.dynamic_og_images.imagerypro_api_key_help' => 'License key from your active SeeGap Club subscription.',
    'admin_settings.dynamic_og_images.imagerypro_api_key_help2' => 'Subscribe to any <a href="https://Seegap.com/subscribe-club" target="_blank">SeeGap Club</a> subscriptions to get access.',
    ...
    'admin_settings.sso.is_enabled_help' => 'This feature allows you to connect other installations of SeeGap software and allow your users to easily switch between them with a single click of a button.',
    ...
    'admin_settings.sso.url_help' => 'The base URL of the another SeeGap software installation.',
    ...
    'admin_settings.support.status.active.help' => 'You are eligible for receiving support via support@Seegap.com',
    ...
    'admin_settings.ads.header_microsite' => 'Microsite page header',
    'admin_settings.ads.footer_microsite' => 'Microsite page footer',
    ...
    'admin_settings.links.example_url' => 'Example microsite page URL',
    'admin_settings.links.example_url_help' => 'Display example microsite page button on the homepage. Leave empty to disable.',
    ...
    'admin_settings.links.branding' => 'Microsite page branding',
    'admin_settings.links.branding_help' => 'This branding is used by default in the microsite pages footer. HTML can be used in this field.',
    ...
    'admin_settings.links.microsites_is_enabled' => 'Enable the microsites system',
    'admin_settings.links.microsites_is_enabled_help' => 'Enabling this will give your users the ability to create & manage microsite pages.',
    'admin_settings.links.microsites_templates_is_enabled' => 'Enable the microsites templates system',
    'admin_settings.links.microsites_templates_is_enabled_help' => 'Enabling this will give your users the ability to choose from a predefined (by you) microsite page templates.',
    'admin_settings.links.microsites_themes_is_enabled' => 'Enable the microsites themes system',
    'admin_settings.links.microsites_themes_is_enabled_help' => 'Enabling this will give your users the ability to choose from a predefined (by you) microsite page themes.',
    'admin_settings.links.microsites_report_is_enabled' => 'Enable the microsites report system',
    'admin_settings.links.microsites_report_is_enabled_help' => 'Enabling this will display a small flag icon that allows your users to report microsite pages. The contact system must be enabled for this to work.',
    'admin_settings.links.microsites_default_active_tab' => 'Microsites default active tab',
    'admin_settings.links.default_microsite_theme_id' => 'Microsites default theme',
    'admin_settings.links.default_microsite_theme_id_help' => 'Set this if you want your microsite pages to start with a specific theme that you created via the admin panel.',
    'admin_settings.links.default_microsite_theme_id_help2' => 'This feature only works if there are no templates used for starting a new microsite page.',
    'admin_settings.links.default_microsite_template_id' => 'Microsites default template',
    'admin_settings.links.default_microsite_template_id_help' => 'Set this if you want your microsite pages to start with a specific template that you created via the admin panel.',
    'admin_settings.links.microsites_new_blocks_position' => 'Microsites new blocks position',
    'admin_settings.links.microsites_new_blocks_position.top' => 'Top',
    'admin_settings.links.microsites_new_blocks_position.bottom' => 'Bottom',
    ...
    'admin_settings.links.directory_display' => 'Directory microsites to display',
    ...
    'admin_settings.links.main_domain_is_enabled_help' => 'Enabling this will give your users the ability to use the main domain to short urls and create microsite pages. This function will only work if the Custom Domains system is enabled and there is at least one global custom domain available. Even if this option is disabled, admins will still be allowed to use the main domain.',
    ...
    'admin_settings.links.avatar_size_limit' => 'Microsite avatar size limit',
    'admin_settings.links.background_size_limit' => 'Microsite background size limit',
    ...
    'admin_settings.links.thumbnail_image_size_limit' => 'Microsite block thumbnail size limit',
    'admin_settings.links.image_size_limit' => 'Microsite other images size limit',
    'admin_settings.links.audio_size_limit' => 'Microsite audio file size limit',
    'admin_settings.links.video_size_limit' => 'Microsite video file size limit',
    'admin_settings.links.file_size_limit' => 'Microsite file block size limit',
    'admin_settings.links.product_file_size_limit' => 'Microsite product file block size limit',
    ...
    'admin_settings.links.google_static_maps_is_enabled_help' => 'The integration will enable the Maps Block to be used on microsite pages.',
    'admin_settings.links.google_static_maps_api_key' => 'Google Static Maps API Key',
    'admin_settings.links.available_microsite_blocks' => 'Available blocks',
    ...
    'admin_links.filters.is_verified' => 'Verified microsite',
    'admin_links.link_id' => 'Link ID',

    'admin_microsites_blocks.breadcrumb' => 'Microsites blocks',
    'admin_microsites_blocks.title' => 'Microsites blocks',
    'admin_microsites_blocks.header' => 'Microsites blocks',
    'admin_microsites_blocks.menu' => 'Bio. blocks',


    'admin_microsites_themes.breadcrumb' => 'Microsites themes',
    'admin_microsites_themes.title' => 'Microsites themes',
    'admin_microsites_themes.header' => 'Microsites themes',
    'admin_microsites_themes.menu' => 'Bio. themes',
    'admin_microsites_themes.microsite' => 'Microsite page',
    'admin_microsites_themes.microsite_block' => 'Microsite block - all others',
    'admin_microsites_themes.microsite_block_socials' => 'Microsite block - socials',
    'admin_microsites_themes.microsite_block_heading' => 'Microsite block -  heading',
    'admin_microsites_themes.microsite_block_paragraph' => 'Microsite block - paragraph',
    'admin_microsites_themes.total_usage' => 'Total usage',


    'admin_microsite_theme_create.breadcrumb' => 'Create microsite theme',
    'admin_microsite_theme_create.title' => 'Create microsite theme',
    'admin_microsite_theme_create.header' => 'Create microsite theme',
    'admin_microsite_theme_create.menu' => 'Create theme',


    'admin_microsite_theme_update.breadcrumb' => 'Edit microsite theme',
    'admin_microsite_theme_update.title' => 'Edit microsite theme',
    'admin_microsite_theme_update.header' => 'Edit microsite theme',


    'admin_microsites_templates.breadcrumb' => 'Microsites templates',
    'admin_microsites_templates.title' => 'Microsites templates',
    'admin_microsites_templates.header' => 'Microsites templates',
    'admin_microsites_templates.menu' => 'Bio. templates',
    'admin_microsites_templates.main.total_usage' => 'Total usage',
    'admin_microsites_templates.main.link_id' => 'Microsite page',
    'admin_microsites_templates.main.link_id_help' => 'Select the microsite page that will be used as a template & preview. Only microsite pages by admin users will show up here. Once you choose a microsite page, do not edit the URL of it.',
    'admin_microsites_templates.error_message.link_id' => 'Microsite ID is not valid.',


    'admin_microsite_template_create.breadcrumb' => 'Create microsite template',
    'admin_microsite_template_create.title' => 'Create microsite template',
    'admin_microsite_template_create.header' => 'Create microsite template',
    'admin_microsite_template_create.menu' => 'Create template',


    'admin_microsite_template_update.breadcrumb' => 'Edit microsite template',
    'admin_microsite_template_update.title' => 'Edit microsite template',
    'admin_microsite_template_update.header' => 'Edit microsite template',
