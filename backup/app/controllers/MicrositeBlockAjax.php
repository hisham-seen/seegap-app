...
class MicrositeBlockAjax extends Controller {
    ...
    private function create() {
        ...
        if(isset($_POST['block_type']) && array_key_exists($_POST['block_type'], $this->microsite_blocks)) {
            ...
            if(in_array($_POST['block_type'], $individual_blocks)) {
                $this->{'create_microsite_' . $_POST['block_type']}();
            }

            else if(in_array($_POST['block_type'], $file_blocks)) {
                $this->create_microsite_file($_POST['block_type']);
            }

            else if(in_array($_POST['block_type'], $embeddable_blocks)) {
                $this->create_microsite_embeddable($_POST['block_type']);
            }
    ...
    private function update() {
        ...
        if(!empty($_POST)) {
            ...
            if(isset($_POST['block_type']) && array_key_exists($_POST['block_type'], $this->microsite_blocks)) {
                ...
                if(in_array($_POST['block_type'], $individual_blocks)) {
                    $this->{'update_microsite_' . $_POST['block_type']}();
                }

                else if(in_array($_POST['block_type'], $file_blocks)) {
                    $this->update_microsite_file($_POST['block_type']);
                }

                else if(in_array($_POST['block_type'], $embeddable_blocks)) {
                    $this->update_microsite_embeddable($_POST['block_type']);
                }
    ...
    private function create_microsite_link() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_link() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
    ...
    private function create_microsite_big_link() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
    ...
    private function update_microsite_big_link() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
        $_POST['description'] = input_clean($_POST['description'], 256);
    ...
    private function create_microsite_heading() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_heading() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['heading_type'] = in_array($_POST['heading_type'], ['h1', 'h2', 'h3', 'h4', 'h5', 'h6']) ? query_clean($_POST['heading_type']) : 'h1';
        $_POST['text'] = mb_substr(query_clean($_POST['text']), 0, 256);
    ...
    private function create_microsite_paragraph() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_paragraph() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['text'] = mb_substr(input_clean($_POST['text']), 0, 2048);
        $_POST['text_color'] = !verify_hex_color($_POST['text_color']) ? '#ffffff' : $_POST['text_color'];
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
    ...
    private function create_microsite_markdown() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['text'] = mb_substr(input_clean($_POST['text']), 0, 2048);
        $_POST['text_color'] = !verify_hex_color($_POST['text_color']) ? '#ffffff' : $_POST['text_color'];
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
    ...
    private function update_microsite_markdown() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['text'] = mb_substr(input_clean($_POST['text']), 0, 2048);
        $_POST['text_color'] = !verify_hex_color($_POST['text_color']) ? '#ffffff' : $_POST['text_color'];
    ...
    private function create_microsite_avatar() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_avatar() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['size'] = in_array($_POST['size'], ['75', '100', '125', '150']) ? (int) $_POST['size'] : 125;
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
        $_POST['border_width'] = in_array($_POST['border_width'], [0, 1, 2, 3, 4, 5]) ? (int) $_POST['border_width'] : 0;
        ...
        /* Image upload */
        $db_image = $this->handle_image_upload($microsite_block->settings->image, 'avatars/', settings()->links->image_size_limit);
    ...
    private function create_microsite_header() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
    ...
    private function update_microsite_header() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['avatar_size'] = in_array($_POST['avatar_size'], ['75', '100']) ? (int) $_POST['avatar_size'] : 125;
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
        $_POST['border_width'] = in_array($_POST['border_width'], [0, 1, 2, 3, 4, 5]) ? (int) $_POST['border_width'] : 0;
        $_POST['border_style'] = in_array($_POST['border_style'], ['solid', 'dashed', 'double', 'inset', 'outset']) ? query_clean($_POST['border_style']) : 'solid';
        $_POST['border_color'] = !verify_hex_color($_POST['border_color']) ? '#000000' : $_POST['border_color'];
        ...
        /* Image upload */
        $background = $this->handle_file_upload($microsite_block->settings->background, 'background', 'background_remove', ['jpg', 'jpeg', 'png', 'svg', 'gif', 'webp', 'avif'], 'backgrounds/', settings()->links->avatar_size_limit);
        $avatar = $this->handle_file_upload($microsite_block->settings->avatar, 'avatar', 'avatar_remove', ['jpg', 'jpeg', 'png', 'svg', 'gif', 'webp', 'avif'], 'avatars/', settings()->links->avatar_size_limit);
    ...
    private function create_microsite_socials() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        ...
        foreach($_POST['socials'] as $key => $value) {
            if(!array_key_exists($key, $microsite_socials)) {
                unset($_POST['socials'][$key]);
            } else {
                $_POST['socials'][$key] = mb_substr(query_clean($_POST['socials'][$key]), 0, $microsite_socials[$key]['max_length']);
            }
        }
    ...
    private function update_microsite_socials() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['color'] = !verify_hex_color($_POST['color']) ? '#ffffff' : $_POST['color'];
        $_POST['background_color'] = !verify_hex_color($_POST['background_color']) ? '#FFFFFF00' : $_POST['background_color'];
        $_POST['size'] = in_array($_POST['size'], ['s', 'm', 'l', 'xl']) ? $_POST['size'] : 'm';
    ...
    private function create_microsite_email_collector() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
    ...
    private function update_microsite_email_collector() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
        $_POST['border_width'] = in_array($_POST['border_width'], [0, 1, 2, 3, 4, 5]) ? (int) $_POST['border_width'] : 0;
    ...
    private function create_microsite_rss_feed() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
    ...
    private function update_microsite_rss_feed() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
        ...
        /* Clear the cache */
        cache()->deleteItem('microsite_blocks?link_id=' . $microsite_block->link_id);
        cache()->deleteItem('microsite_block?block_id=' . $microsite_block->microsite_block_id . '&type=rss_feed');

        Response::json(l('global.success_message.update2'), 'success');
    }

    private function create_microsite_iframe() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
    ...
    private function update_microsite_iframe() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
        ...
        /* Clear the cache */
        cache()->deleteItem('microsite_blocks?link_id=' . $microsite_block->link_id);
        cache()->deleteItem('microsite_block?block_id=' . $microsite_block->microsite_block_id . '&type=iframe');

        Response::json(l('global.success_message.update2'), 'success');
    }

    private function create_microsite_custom_html() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['html'] = mb_substr(trim($_POST['html']), 0, $this->microsite_blocks['custom_html']['max_length']);
    ...
    private function update_microsite_custom_html() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['html'] = mb_substr(trim($_POST['html']), 0, $this->microsite_blocks['custom_html']['max_length']);
    ...
    private function create_microsite_vcard() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
    ...
    private function update_microsite_vcard() {
        $settings = [];
        ...
        $settings['vcard_first_name'] = $_POST['vcard_first_name'] = mb_substr(query_clean($_POST['vcard_first_name']), 0, $this->microsite_blocks['vcard']['fields']['first_name']['max_length']);
        $settings['vcard_last_name'] = $_POST['vcard_last_name'] = mb_substr(query_clean($_POST['vcard_last_name']), 0, $this->microsite_blocks['vcard']['fields']['last_name']['max_length']);
        $settings['vcard_email'] = $_POST['vcard_email'] = mb_substr(query_clean($_POST['vcard_email']), 0, $this->microsite_blocks['vcard']['fields']['email']['max_length']);
        $settings['vcard_url'] = $_POST['vcard_url'] = mb_substr(query_clean($_POST['vcard_url']), 0, $this->microsite_blocks['vcard']['fields']['url']['max_length']);
        $settings['vcard_company'] = $_POST['vcard_company'] = mb_substr(query_clean($_POST['vcard_company']), 0, $this->microsite_blocks['vcard']['fields']['company']['max_length']);
        $settings['vcard_job_title'] = $_POST['vcard_job_title'] = mb_substr(query_clean($_POST['vcard_job_title']), 0, $this->microsite_blocks['vcard']['fields']['job_title']['max_length']);
        $settings['vcard_birthday'] = $_POST['vcard_birthday'] = mb_substr(query_clean($_POST['vcard_birthday']), 0, $this->microsite_blocks['vcard']['fields']['birthday']['max_length']);
        $settings['vcard_street'] = $_POST['vcard_street'] = mb_substr(query_clean($_POST['vcard_street']), 0, $this->microsite_blocks['vcard']['fields']['street']['max_length']);
        $settings['vcard_city'] = $_POST['vcard_city'] = mb_substr(query_clean($_POST['vcard_city']), 0, $this->microsite_blocks['vcard']['fields']['city']['max_length']);
        $settings['vcard_zip'] = $_POST['vcard_zip'] = mb_substr(query_clean($_POST['vcard_zip']), 0, $this->microsite_blocks['vcard']['fields']['zip']['max_length']);
        $settings['vcard_region'] = $_POST['vcard_region'] = mb_substr(query_clean($_POST['vcard_region']), 0, $this->microsite_blocks['vcard']['fields']['region']['max_length']);
        $settings['vcard_country'] = $_POST['vcard_country'] = mb_substr(query_clean($_POST['vcard_country']), 0, $this->microsite_blocks['vcard']['fields']['country']['max_length']);
        $settings['vcard_note'] = $_POST['vcard_note'] = mb_substr(query_clean($_POST['vcard_note']), 0, $this->microsite_blocks['vcard']['fields']['note']['max_length']);
        ...
        foreach($_POST['vcard_phone_number_label'] as $key => $value) {
            ...
            $vcard_phone_numbers[] = [
                'label' => mb_substr(input_clean($value), 0, $this->microsite_blocks['vcard']['fields']['phone_number_value']['max_length']),
                'value' => mb_substr(input_clean($_POST['vcard_phone_number_value'][$key]), 0, $this->microsite_blocks['vcard']['fields']['phone_number_value']['max_length'])
            ];
        }
        ...
        foreach($_POST['vcard_social_label'] as $key => $value) {
            ...
            $vcard_socials[] = [
                'label' => mb_substr(query_clean($value), 0, $this->microsite_blocks['vcard']['fields']['social_value']['max_length']),
                'value' => mb_substr(input_clean($_POST['vcard_social_value'][$key]), 0, $this->microsite_blocks['vcard']['fields']['social_value']['max_length'])
            ];
        }
        ...
        /* Vcard avatar */
        $settings['vcard_avatar'] = $this->handle_file_upload($microsite_block->settings->vcard_avatar, 'vcard_avatar', 'vcard_avatar_remove', \Altum\Uploads::get_whitelisted_file_extensions('vcards_avatars'), 'avatars/', 0.75);
        ...
        if(isset($_POST['vcard_avatar_remove'])) {
            ...
            if(\Altum\Plugin::is_active('offload') && settings()->offload->uploads_url) {
                ...
                $s3->deleteObject([
                    ...
                    'Key' => 'uploads/avatars/' . $microsite_block->settings->vcard_avatar,
                ]);
            }
            ...
            /* Local deleting */
                ...
                /* Delete current file */
                if(!empty($microsite_block->settings->vcard_avatar) && file_exists(UPLOADS_PATH . 'avatars/' . $microsite_block->settings->vcard_avatar)) {
                    unlink(UPLOADS_PATH . 'avatars/' . $microsite_block->settings->vcard_avatar);
                }
            }
    ...
    private function create_microsite_image() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
    ...
    private function update_microsite_image() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
        $_POST['image_alt'] = mb_substr(query_clean($_POST['image_alt']), 0, 100);
        $_POST['open_in_new_tab'] = (int) isset($_POST['open_in_new_tab']);
    ...
    private function create_microsite_image_grid() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
        $_POST['location_url'] = get_url($_POST['location_url']);
    ...
    private function update_microsite_image_grid() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
        $_POST['location_url'] = get_url($_POST['location_url']);
        $_POST['image_alt'] = mb_substr(query_clean($_POST['image_alt']), 0, 100);
    ...
    private function create_microsite_divider() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_divider() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['margin_top'] = $_POST['margin_top'] > 7 || $_POST['margin_top'] < 0 ? 3 : (int) $_POST['margin_top'];
        $_POST['margin_bottom'] = $_POST['margin_bottom'] > 7 || $_POST['margin_bottom'] < 0 ? 3 : (int) $_POST['margin_bottom'];
        $_POST['background_color'] = !verify_hex_color($_POST['background_color']) ? '#ffffff' : $_POST['background_color'];
    ...
    private function create_microsite_list() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['text'] = mb_substr(input_clean($_POST['text']), 0, 2048);
    ...
    private function update_microsite_list() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['text'] = mb_substr(input_clean($_POST['text']), 0, 2048);
        $_POST['icon'] = query_clean($_POST['icon']);
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
    ...
    private function create_microsite_alert() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['text'] = mb_substr(input_clean($_POST['text']), 0, 2048);
    ...
    private function update_microsite_alert() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['text'] = mb_substr(input_clean($_POST['text']), 0, 2048);
        $_POST['icon'] = query_clean($_POST['icon']);
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
    ...
    private function create_microsite_faq() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_faq() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
        $_POST['border_width'] = in_array($_POST['border_width'], [0, 1, 2, 3, 4, 5]) ? (int) $_POST['border_width'] : 0;
        $_POST['border_style'] = in_array($_POST['border_style'], ['solid', 'dashed', 'double', 'inset', 'outset']) ? query_clean($_POST['border_style']) : 'solid';
    ...
    private function create_microsite_timeline() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_timeline() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
        $_POST['border_width'] = in_array($_POST['border_width'], [0, 1, 2, 3, 4, 5]) ? (int) $_POST['border_width'] : 0;
        $_POST['border_style'] = in_array($_POST['border_style'], ['solid', 'dashed', 'double', 'inset', 'outset']) ? query_clean($_POST['border_style']) : 'solid';
    ...
    private function create_microsite_review() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_review() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['title'] = mb_substr(input_clean($_POST['title']), 0, 128);
        $_POST['description'] = mb_substr(input_clean($_POST['description']), 0, 1024);
        $_POST['author_name'] = mb_substr(input_clean($_POST['author_name']), 0, 128);
    ...
    private function create_microsite_image_slider() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_image_slider() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        ...
        foreach($_POST['item_image_alt'] as $key => $value) {
            ...
            $image = $this->handle_file_upload($microsite_block->settings->items->{$key}->image ?? null, 'item_image_' . $key, 'image_remove', ['jpg', 'jpeg', 'png', 'svg', 'ico', 'gif'], 'block_images/', settings()->links->image_size_limit);
    ...
    private function create_microsite_discord() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_discord() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['server_id'] = (int) $_POST['server_id'];
    ...
    private function create_microsite_countdown() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_countdown() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['counter_end_date'] = (new \DateTime($_POST['counter_end_date'], new \DateTimeZone($this->user->timezone)))->setTimezone(new \DateTimeZone(\Altum\Date::$default_timezone))->format('Y-m-d H:i:s');
        $_POST['theme'] = in_array($_POST['theme'], ['light', 'dark']) ? query_clean($_POST['theme']) : 'light';
    ...
    private function create_microsite_cta() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_cta() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['type'] = in_array($_POST['type'], ['email', 'call', 'sms', 'facetime']) ? query_clean($_POST['type']) : 'email';
        $_POST['value'] = mb_substr(query_clean($_POST['value']), 0, 320);
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
    ...
    private function create_microsite_external_item() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
    ...
    private function update_microsite_external_item() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
        $_POST['description'] = mb_substr(query_clean($_POST['description']), 0, 256);
    ...
    private function create_microsite_share() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
    ...
    private function update_microsite_share() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
    ...
    private function create_microsite_coupon() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['name'] = input_clean($_POST['name'], 128);
    ...
    private function update_microsite_coupon() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['location_url'] = get_url($_POST['location_url']);
        $_POST['name'] = input_clean($_POST['name'], 128);
        $_POST['description'] = input_clean($_POST['description'], 256);
    ...
    private function create_microsite_youtube_feed() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_youtube_feed() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['channel_id'] = mb_substr(query_clean($_POST['channel_id']), 0, 128);
        $_POST['amount'] = (int) query_clean($_POST['amount']);
        $_POST['open_in_new_tab'] = (int) isset($_POST['open_in_new_tab']);
    ...
    private function create_microsite_paypal() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_paypal() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['type'] = in_array($_POST['type'], ['buy_now', 'add_to_cart', 'donation']) ? $_POST['type'] : 'buy_now';
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
        $_POST['email'] = mb_substr(query_clean($_POST['email']), 0, 320);
    ...
    private function create_microsite_phone_collector() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
    ...
    private function update_microsite_phone_collector() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
        $_POST['border_width'] = in_array($_POST['border_width'], [0, 1, 2, 3, 4, 5]) ? (int) $_POST['border_width'] : 0;
    ...
    private function create_microsite_contact_collector() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
        ...
        $settings = json_encode([
            ...
            'animation_runs' => 'repeat-1',
            'icon' => '',
            'phone_placeholder' => l('microsite_contact_collector.phone_placeholder_default'),
    ...
    private function update_microsite_contact_collector() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
        $_POST['border_width'] = in_array($_POST['border_width'], [0, 1, 2, 3, 4, 5]) ? (int) $_POST['border_width'] : 0;
    ...
    private function create_microsite_donation() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
    ...
    private function update_microsite_donation() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
        $_POST['border_width'] = in_array($_POST['border_width'], [0, 1, 2, 3, 4, 5]) ? (int) $_POST['border_width'] : 0;
        ...
        $_POST['title'] = mb_substr(query_clean($_POST['title']), 0, $this->microsite_blocks['donation']['fields']['title']['max_length']);
        $_POST['description'] = mb_substr(query_clean($_POST['description']), 0, $this->microsite_blocks['donation']['fields']['description']['max_length']);
        $_POST['prefilled_amount'] = (float) $_POST['prefilled_amount'];
        $_POST['minimum_amount'] = (float) $_POST['minimum_amount'];
        $_POST['currency'] = mb_substr(query_clean($_POST['currency']), 0, $this->microsite_blocks['donation']['fields']['currency']['max_length']);
        $_POST['allow_custom_amount'] = (int) isset($_POST['allow_custom_amount']);
        $_POST['allow_message'] = (int) isset($_POST['allow_message']);
        $_POST['thank_you_title'] = mb_substr(query_clean($_POST['thank_you_title']), 0, $this->microsite_blocks['donation']['fields']['thank_you_title']['max_length']);
        $_POST['thank_you_description'] = mb_substr(query_clean($_POST['thank_you_description']), 0, $this->microsite_blocks['donation']['fields']['thank_you_description']['max_length']);
        $_POST['thank_you_url'] = mb_substr(query_clean($_POST['thank_you_url']), 0, $this->microsite_blocks['donation']['fields']['thank_you_url']['max_length']);
        $_POST['email_notification'] = mb_substr(query_clean($_POST['email_notification']), 0, $this->microsite_blocks['donation']['fields']['email_notification']['max_length']);
        $_POST['webhook_url'] = mb_substr(query_clean($_POST['webhook_url']), 0, $this->microsite_blocks['donation']['fields']['webhook_url']['max_length']);
    ...
    private function create_microsite_product() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
    ...
    private function update_microsite_product() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
        $_POST['border_width'] = in_array($_POST['border_width'], [0, 1, 2, 3, 4, 5]) ? (int) $_POST['border_width'] : 0;
        ...
        $_POST['title'] = mb_substr(query_clean($_POST['title']), 0, $this->microsite_blocks['product']['fields']['title']['max_length']);
        $_POST['description'] = mb_substr(query_clean($_POST['description']), 0, $this->microsite_blocks['product']['fields']['description']['max_length']);
        $_POST['price'] = (float) $_POST['price'];
        $_POST['minimum_price'] = (float) $_POST['minimum_price'];
        $_POST['currency'] = mb_substr(query_clean($_POST['currency']), 0, $this->microsite_blocks['product']['fields']['currency']['max_length']);
        $_POST['allow_custom_price'] = (int) isset($_POST['allow_custom_price']);
        $_POST['thank_you_title'] = mb_substr(query_clean($_POST['thank_you_title']), 0, $this->microsite_blocks['product']['fields']['thank_you_title']['max_length']);
        $_POST['thank_you_description'] = mb_substr(query_clean($_POST['thank_you_description']), 0, $this->microsite_blocks['product']['fields']['thank_you_description']['max_length']);
        $_POST['thank_you_url'] = mb_substr(query_clean($_POST['thank_you_url']), 0, $this->microsite_blocks['donation']['fields']['thank_you_url']['max_length']);
        $_POST['email_notification'] = mb_substr(query_clean($_POST['email_notification']), 0, $this->microsite_blocks['product']['fields']['email_notification']['max_length']);
        $_POST['webhook_url'] = mb_substr(query_clean($_POST['webhook_url']), 0, $this->microsite_blocks['product']['fields']['webhook_url']['max_length']);
        ...
        /* File upload */
        $db_file = $this->handle_file_upload($microsite_block->settings->file, 'file', 'file_remove', $this->microsite_blocks['product']['whitelisted_file_extensions'], \Altum\Uploads::get_path('products_files'), settings()->links->product_file_size_limit);
    ...
    private function create_microsite_service() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
    ...
    private function update_microsite_service() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['name'] = mb_substr(query_clean($_POST['name']), 0, 128);
        $_POST['border_radius'] = in_array($_POST['border_radius'], ['straight', 'round', 'rounded']) ? query_clean($_POST['border_radius']) : 'rounded';
        $_POST['border_width'] = in_array($_POST['border_width'], [0, 1, 2, 3, 4, 5]) ? (int) $_POST['border_width'] : 0;
        ...
        $_POST['title'] = mb_substr(query_clean($_POST['title']), 0, $this->microsite_blocks['service']['fields']['title']['max_length']);
        $_POST['description'] = mb_substr(query_clean($_POST['description']), 0, $this->microsite_blocks['service']['fields']['description']['max_length']);
        $_POST['price'] = (float) $_POST['price'];
        $_POST['currency'] = mb_substr(query_clean($_POST['currency']), 0, $this->microsite_blocks['service']['fields']['currency']['max_length']);
        $_POST['thank_you_title'] = mb_substr(query_clean($_POST['thank_you_title']), 0, $this->microsite_blocks['service']['fields']['thank_you_title']['max_length']);
        $_POST['thank_you_description'] = mb_substr(query_clean($_POST['thank_you_description']), 0, $this->microsite_blocks['service']['fields']['thank_you_description']['max_length']);
        $_POST['thank_you_url'] = mb_substr(query_clean($_POST['thank_you_url']), 0, $this->microsite_blocks['donation']['fields']['thank_you_url']['max_length']);
        $_POST['email_notification'] = mb_substr(query_clean($_POST['email_notification']), 0, $this->microsite_blocks['service']['fields']['email_notification']['max_length']);
        $_POST['webhook_url'] = mb_substr(query_clean($_POST['webhook_url']), 0, $this->microsite_blocks['service']['fields']['webhook_url']['max_length']);
    ...
    private function create_microsite_map() {
        $_POST['link_id'] = (int) $_POST['link_id'];
    ...
    private function update_microsite_map() {
        $_POST['microsite_block_id'] = (int) $_POST['microsite_block_id'];
        $_POST['address'] = mb_substr(query_clean($_POST['address']), 0, 64);
        $_POST['open_in_new_tab'] = (int) isset($_POST['open_in_new_tab']);
        $_POST['location_url'] = get_url($_POST['location_url']);
