...
class ApiQrCodes extends Controller {
    ...
    private function post() {
        ...
        switch ($_POST['type']) {
            ...
            case 'email':
                ...
                $settings['email'] = $_POST['email'] = input_clean($_POST['email'] ?? null, $available_qr_codes['email']['max_length']);
    ...
    private function patch() {
        ...
        switch ($_POST['type']) {
            ...
            case 'email':
                $settings['email'] = $_POST['email'] = input_clean($_POST['email'] ?? $qr_code->settings->email, $available_qr_codes['email']['max_length']);
