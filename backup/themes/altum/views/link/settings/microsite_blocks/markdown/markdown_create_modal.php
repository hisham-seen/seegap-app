...
<div class="modal fade" id="create_microsite_markdown" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('microsite_markdown.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_microsite_text" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="markdown_text"><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('microsite_link.text') ?></label>
