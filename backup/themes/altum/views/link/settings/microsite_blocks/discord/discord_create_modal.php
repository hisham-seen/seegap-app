...
<div class="modal fade" id="create_microsite_discord" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('microsite_discord.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_microsite_discord" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="discord_server_id"><i class="fab fa-fw fa-discord fa-sm text-muted mr-1"></i> <?= l('microsite_discord.server_id') ?></label>
