            ...
            <div class="modal-body">
                <form name="create_microsite_review" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="review_title"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('microsite_review.title') ?></label>
                        <input id="review_title" type="text" name="title" class="form-control" maxlength="128" />
                    </div>

                    <div class="form-group">
                        <label for="review_description"><i class="fas fa-fw fa-pen fa-sm text-muted mr-1"></i> <?= l('microsite_link.description') ?></label>
                    ...
                    <div class="form-group">
                        <label for="review_stars"><i class="fas fa-fw fa-star fa-sm text-muted mr-1"></i> <?= l('microsite_review.stars') ?></label>
