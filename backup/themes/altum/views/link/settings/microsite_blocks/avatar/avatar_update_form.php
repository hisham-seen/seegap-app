...
<form name="update_microsite_" method="post" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="<?= 'avatar_size_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-expand fa-sm text-muted mr-1"></i> <?= l('microsite_avatar.size') ?></label>
        <select id="<?= 'avatar_size_' . $row->microsite_block_id ?>" name="size" class="custom-select">
