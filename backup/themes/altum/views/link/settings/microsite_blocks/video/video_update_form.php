...
<form name="update_microsite_" method="post" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="row">
            <div class="col">
                <input id="<?= 'video_file_' . $row->microsite_block_id ?>" type="file" name="file" accept="<?= \Altum\Uploads::array_to_list_format($data->microsite_blocks['video']['whitelisted_file_extensions']) ?>" class="form-control-file altum-file-input" />
            </div>
        ...
        <small class="form-text text-muted"><?= sprintf(l('global.accessibility.whitelisted_file_extensions'), \Altum\Uploads::array_to_list_format($data->microsite_blocks['video']['whitelisted_file_extensions'])) . ' ' . sprintf(l('global.accessibility.file_size_limit'), settings()->links->file_size_limit) ?></small>
    </div>
