            ...
            <div class="modal-body">
                <form name="create_microsite_excel_spreadsheet" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="excel_spreadsheet_file" type="file" name="file" accept="<?= \Altum\Uploads::array_to_list_format($data->microsite_blocks['excel_spreadsheet']['whitelisted_file_extensions']) ?>" class="form-control-file altum-file-input" required="required" />
