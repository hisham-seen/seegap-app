...
<form name="update_microsite_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'rumble_location_url_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-video fa-sm text-muted mr-1"></i> <?= l('microsite_rumble.location_url') ?></label>
        <input id="<?= 'rumble_location_url_' . $row->microsite_block_id ?>" type="url" class="form-control" name="location_url" value="<?= $row->location_url ?>" placeholder="<?= l('microsite_rumble.location_url_placeholder') ?>" required="required" />
    </div>
