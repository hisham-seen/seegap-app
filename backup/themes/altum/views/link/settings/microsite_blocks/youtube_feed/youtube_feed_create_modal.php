...
<div class="modal fade" id="create_microsite_youtube_feed" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('microsite_youtube_feed.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_microsite_youtube_feed" method="post" role="form">
