            ...
            <div class="modal-body">
                <form name="create_microsite_image_grid" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input id="image_grid_image" type="file" name="image" accept="<?= \Altum\Uploads::array_to_list_format($data->microsite_blocks['image_grid']['whitelisted_image_extensions']) ?>" class="form-control-file altum-file-input" required="required" data-crop />
