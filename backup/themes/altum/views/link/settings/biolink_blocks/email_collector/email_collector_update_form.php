...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="collapse" id="<?= 'email_collector_data_container_' . $row->biolink_block_id ?>">
        ...
        <div class="form-group">
            <label for="<?= 'email_collector_mailchimp_api_' . $row->biolink_block_id ?>"><?= l('biolink_email_collector.mailchimp_api') ?></label>
            ...
            <small class="form-text text-muted"><?= l('biolink_email_collector.mailchimp_api_help') ?></small>
        </div>

        <div class="form-group">
            <label for="<?= 'email_collector_mailchimp_api_list_' . $row->biolink_block_id ?>"><?= l('biolink_email_collector.mailchimp_api_list') ?></label>
            ...
            <small class="form-text text-muted"><?= l('biolink_email_collector.mailchimp_api_list_help') ?></small>
        </div>

        <hr />

        <div class="form-group">
            <label for="<?= 'phone_collector_email_notification_' . $row->biolink_block_id ?>"><?= l('biolink_block.email_notification') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'email_collector_webhook_url_' . $row->biolink_block_id ?>"><?= l('biolink_block.webhook_url') ?></label>
