...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="collapse" id="<?= 'contact_collector_data_container_' . $row->biolink_block_id ?>">
        ...
        <div class="form-group">
            <label for="<?= 'contact_collector_email_notification_' . $row->biolink_block_id ?>"><?= l('biolink_block.email_notification') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'contact_collector_webhook_url_' . $row->biolink_block_id ?>"><?= l('biolink_block.webhook_url') ?></label>
