...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="collapse" id="<?= 'service_data_container_' . $row->biolink_block_id ?>">
        ...
        <div class="form-group">
            <label for="<?= 'service_email_notification_' . $row->biolink_block_id ?>"><?= l('biolink_block.email_notification') ?></label>
            <input type="text" id="<?= 'service_email_notification_' . $row->biolink_block_id ?>" name="email_notification" class="form-control" value="<?= $row->settings->email_notification ?? null ?>" placeholder="<?= l('global.email_placeholder') ?>" maxlength="<?= $data->biolink_blocks['service']['fields']['email_notification']['max_length'] ?>" />
            <small class="form-text text-muted"><?= l('biolink_block.email_notification_help') ?></small>
        </div>

        <div class="form-group">
            <label for="<?= 'service_webhook_url_' . $row->biolink_block_id ?>"><?= l('biolink_block.webhook_url') ?></label>
            <input type="url" id="<?= 'service_webhook_url_' . $row->biolink_block_id ?>" name="webhook_url" class="form-control" value="<?= $row->settings->webhook_url ?? null ?>" placeholder="<?= l('global.url_placeholder') ?>" maxlength="<?= $data->biolink_blocks['service']['fields']['webhook_url']['max_length'] ?>" />
