        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="user_email" name="user_email" class="form-control <?= \SeeGap\Alerts::has_field_errors('user_email') ? 'is-invalid' : null ?>" value="<?= $data->team_member->user_email ?>" placeholder="<?= l('global.email_placeholder') ?>" disabled="disabled" />
                    <?= \SeeGap\Alerts::output_field_error('user_email') ?>
                </div>
