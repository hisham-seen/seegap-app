                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <div class="d-flex align-items-center">
                                <span class="mr-2" data-toggle="tooltip" data-html="true" title="<?= sprintf(l('admin_broadcasts.last_sent_email_datetime'), ($row->last_sent_email_datetime ? '<br />' . \SeeGap\Date::get($row->last_sent_email_datetime, 2) . '<br /><small>' . \SeeGap\Date::get($row->last_sent_email_datetime, 3) . '</small>' : '<br />-')) ?>">
