        ...
        <div class="card">
            <div class="card-body">
                <div class="nav flex-column nav-pills">
                    ...
                    <a class="nav-link <?= $data->type == 'products' ? 'active' : null ?>" href="<?= url('admin/statistics/products?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-box mr-1"></i> <?= l('admin_statistics.products.menu') ?></a>
