        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="plan_settings" style="display: none">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="microsites_limit" name="microsites_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->microsites_limit ?>" />
                ...
                <div class="form-group">
                    ...
                    <select id="microsites_templates" name="microsites_templates[]" class="custom-select" multiple="multiple">
                        <?php foreach($data->microsites_templates as $microsite_template): ?>
                            <option value="<?= $microsite_template->microsite_template_id ?>" <?= in_array($microsite_template->microsite_template_id, $data->user->plan_settings->microsites_templates ?? [])  ? 'selected="selected"' : null ?>>
                ...
                <div class="form-group">
                    ...
                    <select id="microsites_themes" name="microsites_themes[]" class="custom-select" multiple="multiple">
                        <?php foreach($data->microsites_themes as $microsite_theme): ?>
                            <option value="<?= $microsite_theme->microsite_theme_id ?>" <?= in_array($microsite_theme->microsite_theme_id, $data->user->plan_settings->microsites_themes ?? [])  ? 'selected="selected"' : null ?>>
