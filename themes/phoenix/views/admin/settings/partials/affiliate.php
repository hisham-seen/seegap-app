...
<div>
    ...
    <div <?= !\SeeGap\Plugin::is_active('affiliate') ? 'data-toggle="tooltip" title="' . sprintf(l('admin_plugins.no_access'), \SeeGap\Plugin::get('affiliate')->name ?? 'affiliate') . '"' : null ?>>
        <div class="<?= !in_array(settings()->license->type, ['Extended License', 'extended']) || !\SeeGap\Plugin::is_active('affiliate') ? 'container-disabled' : null ?>">
            <div class="form-group custom-control custom-switch">
                <input id="is_enabled" name="is_enabled" type="checkbox" class="custom-control-input" <?= \SeeGap\Plugin::is_active('affiliate') && settings()->affiliate->is_enabled ? 'checked="checked"' : null?>>
            ...
            <div class="form-group">
                ...
                <select id="commission_type" name="commission_type" class="custom-select">
                    <option value="once" <?= \SeeGap\Plugin::is_active('affiliate') && settings()->affiliate->commission_type == 'once' ? 'selected="selected"' : null ?>><?= l('admin_settings.affiliate.commission_type_once') ?></option>
                    <option value="forever" <?= \SeeGap\Plugin::is_active('affiliate') && settings()->affiliate->commission_type == 'forever' ? 'selected="selected"' : null ?>><?= l('admin_settings.affiliate.commission_type_forever') ?></option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="tracking_type" name="tracking_type" class="custom-select">
                    <option value="first" <?= \SeeGap\Plugin::is_active('affiliate') && settings()->affiliate->tracking_type == 'first' ? 'selected="selected"' : null ?>><?= l('admin_settings.affiliate.tracking_type_first') ?></option>
                    <option value="last" <?= \SeeGap\Plugin::is_active('affiliate') && settings()->affiliate->tracking_type == 'last' ? 'selected="selected"' : null ?>><?= l('admin_settings.affiliate.tracking_type_last') ?></option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input id="tracking_duration" type="number" min="1" name="tracking_duration" class="form-control" value="<?= \SeeGap\Plugin::is_active('affiliate') ? settings()->affiliate->tracking_duration : 30 ?>" />
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input id="minimum_withdrawal_amount" type="number" min="1" name="minimum_withdrawal_amount" class="form-control" value="<?= \SeeGap\Plugin::is_active('affiliate') ? settings()->affiliate->minimum_withdrawal_amount : 1 ?>" />
                    <div class="input-group-append">
            ...
            <div class="form-group">
                ...
                <textarea id="withdrawal_notes" name="withdrawal_notes" class="form-control"><?= \SeeGap\Plugin::is_active('affiliate') ? settings()->affiliate->withdrawal_notes : null ?></textarea>
