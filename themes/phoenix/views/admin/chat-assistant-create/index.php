    ...
    <div class="card-body">
        <form action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <?php foreach(\SeeGap\Language::$active_languages as $language_name => $language_code): ?>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="<?= 'translation_' . $language_name . '_name' ?>" name="<?= 'translations[' . $language_name . '][name]' ?>" value="<?= $data->values['translations'][$language_name]['name'] ?? null ?>" class="form-control <?= \SeeGap\Alerts::has_field_errors('translations_' . $language_name . '_name') ? 'is-invalid' : null ?>" maxlength="64" required="required" />
                        </div>
            ...
            <div class="form-group">
                ...
                <textarea id="prompt" name="prompt" class="form-control <?= \SeeGap\Alerts::has_field_errors('prompt') ? 'is-invalid' : null ?>" placeholder="<?= l('admin_chats_assistants.main.prompt_placeholder') ?>" maxlength="5000" required="required"><?= $data->values['name'] ?></textarea>
            ...
            <div class="form-group">
                ...
                <input id="order" type="number" name="order" value="<?= $data->values['order'] ?>" class="form-control <?= \SeeGap\Alerts::has_field_errors('order') ? 'is-invalid' : null ?>" />
