                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-end">
                            <?= include_view(THEME_PATH . 'views/admin/syntheses/admin_synthesis_dropdown_button.php', ['id' => $row->synthesis_id, 'resource_name' => $row->name, 'file' => $row->file, 'synthesis_url' => \SeeGap\Uploads::get_full_url('syntheses') . $row->file]) ?>
                        </div>
                    </td>
                </tr>
            <?php endforeach ?>
