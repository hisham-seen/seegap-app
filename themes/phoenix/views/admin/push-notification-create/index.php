    ...
    <div class="card-body">
        ...
        <form id="form" action="" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" value="<?= $data->values['title'] ?>" class="form-control <?= \SeeGap\Alerts::has_field_errors('title') ? 'is-invalid' : null ?>" maxlength="64" required="required" />
            ...
            <div class="form-group">
                ...
                <input type="text" id="description" name="description" value="<?= $data->values['description'] ?>" class="form-control <?= \SeeGap\Alerts::has_field_errors('description') ? 'is-invalid' : null ?>" maxlength="64" required="required" />
            ...
            <div class="form-group">
                ...
                <input type="url" id="url" name="url" value="<?= $data->values['url'] ?>" class="form-control <?= \SeeGap\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" maxlength="512" placeholder="<?= l('global.url_placeholder') ?>" />
            ...
            <div class="form-group" data-segment="custom">
                ...
                <input type="text" id="push_subscribers_ids" name="push_subscribers_ids" value="<?= $data->values['push_subscribers_ids'] ?>" class="form-control <?= \SeeGap\Alerts::has_field_errors('push_subscribers_ids') ? 'is-invalid' : null ?>" placeholder="<?= l('admin_push_notifications.main.push_subscribers_ids_placeholder') ?>" required="required" />
