...
<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        ...
        <a href="#" data-toggle="modal" data-target="#gs1_link_delete_modal" data-gs1-link-id="<?= $data->id ?>" data-gtin="<?= $data->resource_name ?>" data-name="<?= $data->name ?: $data->resource_name ?>" data-target-url="<?= $data->target_url ?>" data-resource-name="<?= $data->name ?: $data->resource_name ?>" class="dropdown-item">
