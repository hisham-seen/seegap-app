        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <select id="plan_id" name="plan_id" class="custom-select" required="required">
                        <?php foreach($data->plans as $plan): ?>
                            ...
                            <option value="<?= $plan->plan_id ?>" <?= $data->values['plan_id'] == $plan->plan_id ? 'selected="selected"' : null ?>><?= $plan->translations->{\SeeGap\Language::$name}->name ?: $plan->name ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="code" name="code" class="form-control <?= \SeeGap\Alerts::has_field_errors('code') ? 'is-invalid' : null ?>" value="<?= $data->values['code'] ?>" required="required" />
                    <?= \SeeGap\Alerts::output_field_error('code') ?>
                </div>
