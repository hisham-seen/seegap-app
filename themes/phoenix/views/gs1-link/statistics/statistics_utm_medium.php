                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between mb-1">
                        <div class="text-truncate">
                            <a href="<?= url('gs1-link/' . $data->gs1_link->gs1_link_id . '/' . $data->method . '?type=utm_campaign&utm_source=' . $data->utm_source . '&utm_medium=' . $row->utm_medium . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><?= $row->utm_medium ?></a>
                        </div>
