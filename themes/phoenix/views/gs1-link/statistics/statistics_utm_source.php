                    ...
                    <div class="d-flex justify-content-between mb-1">
                        <div class="text-truncate">
                            <?php if(!empty($row->utm_source)): ?>
                                <a href="<?= url('gs1-link/' . $data->gs1_link->gs1_link_id . '/' . $data->method . '?type=utm_medium&utm_source=' . $row->utm_source . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><?= $row->utm_source ?></a>
                            <?php else: ?>
                                <?= l('global.none') ?>
                            <?php endif ?>
                        </div>
