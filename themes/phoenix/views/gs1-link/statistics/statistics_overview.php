...
<div class="row mb-4">
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('gs1-link/' . $data->gs1_link->gs1_link_id . '/' . $data->method . '?type=continent_code&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                ...
                                <?php if($key): ?>
                                    <a href="<?= url('gs1-link/' . $data->gs1_link->gs1_link_id . '/' . $data->method . '?type=city_name&country_code=' . $key . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $key ?>" class=""><?= get_country_from_country_code($key) ?></a>
                                <?php else: ?>
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('gs1-link/' . $data->gs1_link->gs1_link_id . '/' . $data->method . '?type=country&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('gs1-link/' . $data->gs1_link->gs1_link_id . '/' . $data->method . '?type=city_name&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
                        ...
                        <div class="d-flex justify-content-between mb-1">
                            <div class="text-truncate">
                                ...
                                <?php else: ?>
                                    ...
                                    <a href="<?= url('gs1-link/' . $data->gs1_link->gs1_link_id . '/' . $data->method . '?type=referrer_path&referrer_host=' . $key . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $key ?>" class=""><?= $key ?></a>
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('gs1-link/' . $data->gs1_link->gs1_link_id . '/' . $data->method . '?type=referrer_host&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('gs1-link/' . $data->gs1_link->gs1_link_id . '/' . $data->method . '?type=device&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('gs1-link/' . $data->gs1_link->gs1_link_id . '/' . $data->method . '?type=os&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('gs1-link/' . $data->gs1_link->gs1_link_id . '/' . $data->method . '?type=browser&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="card-body small py-3 d-flex align-items-end">
                <a href="<?= url('gs1-link/' . $data->gs1_link->gs1_link_id . '/' . $data->method . '?type=language&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted text-decoration-none"><i class="fas fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('global.view_more') ?></a>
            </div>
        </div>
    </div>
</div>
...
<div>
    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
            ...
            <tr>
                <td colspan="7">
                    <a href="<?= url('gs1-link/' . $data->gs1_link->gs1_link_id . '/' . $data->method . '?type=entries&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted">
