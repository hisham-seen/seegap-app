<div class="card">
    <div class="card-header">
        ...
        <p class="text-muted small mb-0"><?= l('products.content_compliance_description') ?></p>
    </div>
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-3">
                <div class="form-check">
                    ...
                    >
                    <label class="form-check-label" for="halal_certified">
            ...
            <div class="col-lg-6 mb-3">
                <div class="form-check">
                    ...
                    >
                    <label class="form-check-label" for="kosher_certified">
            ...
            <div class="col-lg-6 mb-3">
                <div class="form-check">
                    ...
                    >
                    <label class="form-check-label" for="non_gmo">
                        <?= l('products.non_gmo') ?>
                    </label>
                </div>
