...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <small class="text-muted"><?= l('products.media_images_description') ?></small>
</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-3">
            <label for="main_image" class="form-label">
                <i class="fas fa-fw fa-camera fa-sm text-muted mr-1"></i>
...
<div class="mb-4">
    <h6 class="mb-3">
        <i class="fas fa-file-pdf fa-sm mr-2"></i>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-3">
            <label for="brochure_file" class="form-label">
                <i class="fas fa-fw fa-braille fa-sm text-muted mr-1"></i>
...
<div class="mb-4">
    <h6 class="mb-3">
        <i class="fas fa-video fa-sm mr-2"></i>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-3">
            <label for="product_video" class="form-label">
                <i class="fas fa-fw fa-film fa-sm text-muted mr-1"></i>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-3">
            <label for="model_3d_file" class="form-label">
                <i class="fas fa-fw fa-shapes fa-sm text-muted mr-1"></i>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-3">
            <div class="custom-control custom-checkbox">
                ...
                >
                <label class="custom-control-label" for="auto_resize_images">
        ...
        <div class="col-lg-6 mb-3">
            <div class="custom-control custom-checkbox">
                ...
                >
                <label class="custom-control-label" for="generate_thumbnails">
        ...
        <div class="col-lg-6 mb-3">
            <div class="custom-control custom-checkbox">
                ...
                >
                <label class="custom-control-label" for="watermark_images">
                    <i class="fas fa-fw fa-copyright fa-sm text-muted mr-1"></i>
