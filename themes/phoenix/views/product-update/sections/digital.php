...
<input type="hidden" name="section" value="digital" />
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <small class="text-muted"><?= l('products.digital_integration_description') ?></small>
</div>

<!-- Product URLs & Links -->
<div class="mb-4">
    <h6 class="mb-3">
        <i class="fas fa-link fa-sm mr-2"></i>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-3">
            <label for="product_info_url" class="form-label">
                <i class="fas fa-fw fa-info-circle fa-sm text-muted mr-1"></i>
...
<div class="mb-4">
    <h6 class="mb-3">
        <i class="fas fa-share-alt fa-sm mr-2"></i>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-3">
            <label for="youtube_url" class="form-label">
                <i class="fab fa-fw fa-youtube fa-sm text-muted mr-1"></i>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-3">
            <label for="purchase_url" class="form-label">
                <i class="fas fa-fw fa-shopping-bag fa-sm text-muted mr-1"></i>
        ...
        <div class="col-lg-6 mb-3">
            <label for="amazon_asin" class="form-label">
                <i class="fab fa-fw fa-amazon fa-sm text-muted mr-1"></i>
        ...
        <div class="col-lg-6 mb-3">
            <label for="ebay_item_id" class="form-label">
                <i class="fab fa-fw fa-ebay fa-sm text-muted mr-1"></i>
        ...
        <div class="col-lg-6 mb-3">
            <label for="price_comparison_url" class="form-label">
                <i class="fas fa-fw fa-chart-line fa-sm text-muted mr-1"></i>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-3">
            <label for="manual_url" class="form-label">
                <i class="fas fa-fw fa-book fa-sm text-muted mr-1"></i>
        ...
        <div class="col-lg-6 mb-3">
            <label for="support_url" class="form-label">
                <i class="fas fa-fw fa-life-ring fa-sm text-muted mr-1"></i>
        ...
        <div class="col-lg-6 mb-3">
            <label for="faq_url" class="form-label">
                <i class="fas fa-fw fa-question-circle fa-sm text-muted mr-1"></i>
                <?= l('products.faq_url') ?>
            </label>
            <input 
                type="url" 
...
<div class="mb-4">
    <h6 class="mb-3">
        <i class="fas fa-code fa-sm mr-2"></i>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-3">
            <label for="api_endpoint" class="form-label">
                <i class="fas fa-fw fa-plug fa-sm text-muted mr-1"></i>
        ...
        <div class="col-lg-6 mb-3">
            <label for="webhook_url" class="form-label">
                <i class="fas fa-fw fa-webhook fa-sm text-muted mr-1"></i>
