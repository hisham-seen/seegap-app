...
<?php if(is_logged_in() && \SeeGap\Teams::is_delegated()): ?>
    <div class="team-delegate-access-wrapper py-2 bg-gray-200 small text-muted">
        <div class="container d-flex justify-content-between">
            <div><i class="fas fa-fw fa-sm fa-user-shield mr-1"></i> <?= sprintf(l('global.team_delegate_access_help'), '<strong>' . $this->user->name . '</strong>', '<strong>' . \SeeGap\Teams::$team->name . '</strong>') ?></div>
