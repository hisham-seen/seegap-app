...
<form name="update_microsite_" method="post" role="form">
    ...
    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'phone_collector_settings_container_' . $row->microsite_block_id ?>" aria-expanded="false" aria-controls="<?= 'phone_collector_settings_container_' . $row->microsite_block_id ?>">
        <i class="fas fa-fw fa-wrench fa-sm mr-1"></i> <?= l('microsite_phone_collector.phone_collector_header') ?>
    </button>

    <div class="collapse" id="<?= 'phone_collector_settings_container_' . $row->microsite_block_id ?>">
        <div class="form-group">
            <label for="<?= 'phone_collector_phone_placeholder_' . $row->microsite_block_id ?>"><?= l('microsite_phone_collector.phone_placeholder') ?></label>
            <input id="<?= 'phone_collector_phone_placeholder_' . $row->microsite_block_id ?>" type="text" name="phone_placeholder" class="form-control" value="<?= $row->settings->phone_placeholder ?>" maxlength="64" required="required" />
        </div>

        <div class="form-group">
            <label for="<?= 'phone_collector_name_placeholder_' . $row->microsite_block_id ?>"><?= l('microsite_phone_collector.name_placeholder') ?></label>
            <input id="<?= 'phone_collector_name_placeholder_' . $row->microsite_block_id ?>" type="text" name="name_placeholder" class="form-control" value="<?= $row->settings->name_placeholder ?>" maxlength="64" required="required" />
        </div>

        <div class="form-group">
            <label for="<?= 'phone_collector_button_text_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-square fa-sm text-muted mr-1"></i> <?= l('microsite_link.button_text') ?></label>
            <input id="<?= 'phone_collector_button_text_' . $row->microsite_block_id ?>" type="text" name="button_text" class="form-control" value="<?= $row->settings->button_text ?>" maxlength="64" required="required" />
        </div>

        <div class="form-group">
            <label for="<?= 'phone_collector_success_text_' . $row->microsite_block_id ?>"><?= l('microsite_phone_collector.success_text') ?></label>
            <input id="<?= 'phone_collector_success_text_' . $row->microsite_block_id ?>" type="text" name="success_text" class="form-control" value="<?= $row->settings->success_text ?>" maxlength="256" required="required" />
        </div>

        <div class="form-group">
            <label for="<?= 'phone_collector_thank_you_url_' . $row->microsite_block_id ?>"><?= l('microsite_phone_collector.thank_you_url') ?></label>
            <input id="<?= 'phone_collector_thank_you_url_' . $row->microsite_block_id ?>" type="url" name="thank_you_url" class="form-control" value="<?= $row->settings->thank_you_url ?>" placeholder="<?= l('global.url_placeholder') ?>" maxlength="2048" />
        </div>
        ...
        <div class="form-group custom-control custom-switch">
            <input
                    ...
                    id="<?= 'phone_collector_show_agreement_' . $row->microsite_block_id ?>"
                    name="show_agreement"
                <?= $row->settings->show_agreement ? 'checked="checked"' : null ?>
            >
            <label class="custom-control-label" for="<?= 'phone_collector_show_agreement_' . $row->microsite_block_id ?>"><?= l('microsite_phone_collector.show_agreement') ?></label>
            <div><small class="form-text text-muted"><?= l('microsite_phone_collector.show_agreement_help') ?></small></div>
        </div>

        <div class="form-group">
            <label for="<?= 'phone_collector_agreement_text_' . $row->microsite_block_id ?>"><?= l('microsite_phone_collector.agreement_text') ?></label>
            <input id="<?= 'phone_collector_agreement_text_' . $row->microsite_block_id ?>" type="text" name="agreement_text" class="form-control" value="<?= $row->settings->agreement_text ?>" maxlength="256" />
        </div>

        <div class="form-group">
            <label for="<?= 'phone_collector_agreement_url_' . $row->microsite_block_id ?>"><?= l('microsite_phone_collector.agreement_url') ?></label>
            <input id="<?= 'phone_collector_agreement_url_' . $row->microsite_block_id ?>" type="text" name="agreement_url" class="form-control" value="<?= $row->settings->agreement_url ?>" placeholder="<?= l('global.url_placeholder') ?>" maxlength="2048" />
        </div>
    </div>

    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'phone_collector_data_container_' . $row->microsite_block_id ?>" aria-expanded="false" aria-controls="<?= 'phone_collector_data_container_' . $row->microsite_block_id ?>">
        <i class="fas fa-fw fa-database fa-sm mr-1"></i> <?= l('microsite_block.data_header') ?>
    </button>

    <div class="collapse" id="<?= 'phone_collector_data_container_' . $row->microsite_block_id ?>">
        ...
        <div class="form-group">
            <label for="<?= 'phone_collector_webhook_url_' . $row->microsite_block_id ?>"><?= l('microsite_block.webhook_url') ?></label>
            <input id="<?= 'phone_collector_webhook_url_' . $row->microsite_block_id ?>" type="text" name="webhook_url" class="form-control" value="<?= $row->settings->webhook_url ?>" placeholder="<?= l('global.url_placeholder') ?>" maxlength="2048" />
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->microsite_block_id ?>">
        <div class="form-group">
            <label for="<?= 'phone_collector_name_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('microsite_link.name') ?></label>
            <input id="<?= 'phone_collector_name_' . $row->microsite_block_id ?>" type="text" name="name" class="form-control" value="<?= $row->settings->name ?>" maxlength="128" required="required" />
        </div>
        ...
        <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= settings()->links->thumbnail_image_size_limit ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), settings()->links->thumbnail_image_size_limit) ?>">
            <label for="<?= 'phone_collector_image_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-image fa-sm text-muted mr-1"></i> <?= l('microsite_link.image') ?></label>
            <?= include_view(THEME_PATH . 'views/partials/custom_file_image_input.php', [
                'id'=> 'phone_collector_image_' . $row->microsite_block_id,
                'uploads_file_key' => 'block_thumbnail_images',
                'file_key' => 'image',
                'already_existing_image' => $row->settings->image,
                'image_container' => 'image',
                'accept' => \SeeGap\Uploads::array_to_list_format($data->microsite_blocks['phone_collector']['whitelisted_thumbnail_image_extensions']),
            ]) ?>
            <small class="form-text text-muted"><?= sprintf(l('global.accessibility.whitelisted_file_extensions'), \SeeGap\Uploads::array_to_list_format($data->microsite_blocks['phone_collector']['whitelisted_thumbnail_image_extensions'])) . ' ' . sprintf(l('global.accessibility.file_size_limit'), settings()->links->thumbnail_image_size_limit) ?></small>
        </div>

        <div class="form-group">
            <label for="<?= 'phone_collector_icon_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-icons fa-sm text-muted mr-1"></i> <?= l('global.icon') ?></label>
            <input id="<?= 'phone_collector_icon_' . $row->microsite_block_id ?>" type="text" name="icon" class="form-control" value="<?= $row->settings->icon ?>" placeholder="<?= l('global.icon_placeholder') ?>" />
            <small class="form-text text-muted"><?= l('global.icon_help') ?></small>
        </div>

        <div class="form-group">
            <label for="<?= 'phone_collector_text_color_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('microsite_link.text_color') ?></label>
            <input id="<?= 'phone_collector_text_color_' . $row->microsite_block_id ?>" type="hidden" name="text_color" class="form-control" value="<?= $row->settings->text_color ?>" required="required" />
        ...
        <div class="form-group">
            <label for="<?= 'phone_collector_background_color_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('microsite_link.background_color') ?></label>
            <input id="<?= 'phone_collector_background_color_' . $row->microsite_block_id ?>" type="hidden" name="background_color" class="form-control" value="<?= $row->settings->background_color ?>" required="required" />
            <div class="background_color_pickr"></div>
        </div>

        <div class="form-group">
            <label for="<?= 'phone_collector_animation_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-film fa-sm text-muted mr-1"></i> <?= l('microsite_link.animation') ?></label>
            <select id="<?= 'phone_collector_animation_' . $row->microsite_block_id ?>" name="animation" class="custom-select">
        ...
        <div class="form-group" data-animation="<?= implode(',', require APP_PATH . 'includes/microsite_animations.php') ?>">
            <label for="<?= 'phone_collector_animation_runs_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-play-circle fa-sm text-muted mr-1"></i> <?= l('microsite_link.animation_runs') ?></label>
            <select id="<?= 'phone_collector_animation_runs_' . $row->microsite_block_id ?>" name="animation_runs" class="custom-select">
