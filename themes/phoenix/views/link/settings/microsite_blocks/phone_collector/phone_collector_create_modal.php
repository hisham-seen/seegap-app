...
<div class="modal fade" id="create_microsite_phone_collector" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('microsite_phone_collector.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_microsite_phone_collector" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="phone_collector_name"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('microsite_link.name') ?></label>
