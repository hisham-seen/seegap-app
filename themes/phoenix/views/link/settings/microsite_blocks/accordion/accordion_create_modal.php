...
<div class="modal fade" id="create_microsite_accordion" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('microsite_accordion.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_microsite_accordion" method="post" role="form">
...
<template id="template_accordion_item">
    <div class="accordion-item-wrapper mb-3 border rounded" data-accordion-item>
        ...
        <div class="accordion-item-header d-flex align-items-center justify-content-between p-3 bg-light border-bottom" style="cursor: pointer;" data-toggle="collapse" data-target="#accordion-item-content-create-{index}">
        ...
        <!-- Collapsible Content -->
        <div id="accordion-item-content-create-{index}" class="collapse show">
            <div class="p-3">
...
function updateFieldNames(containerId) {
    ...
    items.forEach((item, index) => {
        ...
        if (collapseContent && toggleButton) {
            const newId = `accordion-item-content-create-${index}`;
...
// Show modal and initialize first item
$('#create_microsite_accordion').on('shown.bs.modal', function(event) {
    // Add first accordion item
    $(event.currentTarget).find('button[data-add]').click();
    
    // Initialize drag and drop
    setTimeout(() => {
        initializeDragAndDrop('accordion_items_create');
    }, 200);
});
