        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="create_microsite_accordion" method="post" role="form">
                    ...
                    <div id="<?= 'accordion_items_create' ?>" data-microsite-block-id="create"></div>

                    <div class="mb-3">
                        <button data-add="accordion_item" data-microsite-block-id="create" type="button" class="btn btn-outline-success btn-block"><i class="fas fa-fw fa-plus-circle fa-sm mr-1"></i> <?= l('global.create') ?></button>
                    </div>
...
<?php ob_start() ?>
    <script>
        ...
        $('#create_microsite_accordion').on('shown.bs.modal', event => {
