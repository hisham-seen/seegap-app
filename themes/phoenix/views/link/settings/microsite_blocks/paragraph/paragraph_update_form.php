...
<form name="update_microsite_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'paragraph_text_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('microsite_link.text') ?></label>
        <textarea id="<?= 'paragraph_text_' . $row->microsite_block_id ?>" class="form-control" name="text" maxlength="2048"><?= $row->settings->text ?></textarea>
    </div>
    ...
    <div class="form-group">
        <label for="<?= 'paragraph_background_color_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('microsite_link.background_color') ?></label>
        <input id="<?= 'paragraph_background_color_' . $row->microsite_block_id ?>" type="hidden" name="background_color" class="form-control" value="<?= $row->settings->background_color ?>" required="required" />
