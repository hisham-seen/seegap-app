        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="create_microsite_avatar" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="avatar_size"><i class="fas fa-fw fa-expand fa-sm text-muted mr-1"></i> <?= l('microsite_avatar.size') ?></label>
                    ...
                    <div class="form-group">
                        <label for="avatar_border_radius"><i class="fas fa-fw fa-border-all fa-sm text-muted mr-1"></i> <?= l('microsite_avatar.border_radius') ?></label>
                        <select id="avatar_border_radius" name="border_radius" class="custom-select">
                            <option value="straight"><?= l('microsite_avatar.border_radius_straight') ?></option>
                            <option value="round"><?= l('microsite_avatar.border_radius_round') ?></option>
                            <option value="rounded"><?= l('microsite_avatar.border_radius_rounded') ?></option>
                        </select>
                    </div>
