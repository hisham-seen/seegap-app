            ...
            <div class="modal-body">
                <form name="create_microsite_image" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input id="image_image" type="file" name="image" accept="<?= \SeeGap\Uploads::array_to_list_format($data->microsite_blocks["image"]["whitelisted_image_extensions"] ?? ["jpg", "jpeg", "png", "gif", "webp", "svg"]) ?>" class="form-control-file seegap-file-input" required="required" data-crop />
