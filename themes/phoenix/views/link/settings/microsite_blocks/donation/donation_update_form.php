...
<form name="update_microsite_" method="post" role="form">
    ...
    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'donation_settings_container_' . $row->microsite_block_id ?>" aria-expanded="false" aria-controls="<?= 'donation_settings_container_' . $row->microsite_block_id ?>">
        <i class="fas fa-fw fa-hand-holding-dollar fa-sm mr-1"></i> <?= l('microsite_donation.donation_header') ?>
    </button>

    <div class="collapse" id="<?= 'donation_settings_container_' . $row->microsite_block_id ?>">
        <div class="form-group">
            <label for="<?= 'donation_title_' . $row->microsite_block_id ?>"><?= l('microsite_donation.title') ?></label>
            <input type="text" id="<?= 'donation_title_' . $row->microsite_block_id ?>" name="title" class="form-control" value="<?= $row->settings->title ?? null ?>" maxlength="<?= $data->microsite_blocks['donation']['fields']['title']['max_length'] ?>" />
        </div>

        <div class="form-group">
            <label for="<?= 'donation_description_' . $row->microsite_block_id ?>"><?= l('microsite_donation.description') ?></label>
            <input type="text" id="<?= 'donation_description_' . $row->microsite_block_id ?>" name="description" class="form-control" value="<?= $row->settings->description ?? null ?>" maxlength="<?= $data->microsite_blocks['donation']['fields']['description']['max_length'] ?>" />
        </div>

        <div class="form-group">
            <label for="<?= 'donation_prefilled_amount_' . $row->microsite_block_id ?>"><?= l('microsite_donation.prefilled_amount') ?></label>
            <input type="number" min="0" step="0.01" id="<?= 'donation_prefilled_amount_' . $row->microsite_block_id ?>" name="prefilled_amount" class="form-control" value="<?= $row->settings->prefilled_amount ?? null ?>" />
        </div>

        <div class="form-group">
            <label for="<?= 'donation_minimum_amount_' . $row->microsite_block_id ?>"><?= l('microsite_donation.minimum_amount') ?></label>
            <input type="number" min="0" step="0.01" id="<?= 'donation_minimum_amount_' . $row->microsite_block_id ?>" name="minimum_amount" class="form-control" value="<?= $row->settings->minimum_amount ?? null ?>" />
        </div>

        <div class="form-group">
            <label for="<?= 'donation_currency_' . $row->microsite_block_id ?>"><?= l('microsite_donation.currency') ?></label>
            <input type="text" id="<?= 'donation_currency_' . $row->microsite_block_id ?>" name="currency" class="form-control" value="<?= $row->settings->currency ?? null ?>" maxlength="<?= $data->microsite_blocks['donation']['fields']['currency']['max_length'] ?>" />
            <small class="form-text text-muted"><?= l('microsite_donation.currency_help') ?></small>
        </div>

        <div class="form-group custom-control custom-switch">
            <input id="<?= 'donation_allow_custom_amount_' . $row->microsite_block_id ?>" name="allow_custom_amount" type="checkbox" class="custom-control-input" <?= ($row->settings->allow_custom_amount ?? null) ? 'checked="checked"' : null?>>
            <label class="custom-control-label" for="<?= 'donation_allow_custom_amount_' . $row->microsite_block_id ?>"><?= l('microsite_donation.allow_custom_amount') ?></label>
        </div>

        <div class="form-group custom-control custom-switch">
            <input id="<?= 'donation_allow_message_' . $row->microsite_block_id ?>" name="allow_message" type="checkbox" class="custom-control-input" <?= ($row->settings->allow_message ?? null) ? 'checked="checked"' : null?>>
            <label class="custom-control-label" for="<?= 'donation_allow_message_' . $row->microsite_block_id ?>"><?= l('microsite_donation.allow_message') ?></label>
            <small class="form-text text-muted"><?= l('microsite_donation.allow_message_help') ?></small>
        </div>

        <div class="form-group">
            <label for="<?= 'donation_thank_you_title_' . $row->microsite_block_id ?>"><?= l('microsite_donation.thank_you_title') ?></label>
            <input type="text" id="<?= 'donation_thank_you_title_' . $row->microsite_block_id ?>" name="thank_you_title" class="form-control" value="<?= $row->settings->thank_you_title ?? null ?>" maxlength="<?= $data->microsite_blocks['donation']['fields']['thank_you_title']['max_length'] ?>" />
        </div>

        <div class="form-group">
            <label for="<?= 'donation_thank_you_description_' . $row->microsite_block_id ?>"><?= l('microsite_donation.thank_you_description') ?></label>
            <input type="text" id="<?= 'donation_thank_you_description_' . $row->microsite_block_id ?>" name="thank_you_description" class="form-control" value="<?= $row->settings->thank_you_description ?? null ?>" maxlength="<?= $data->microsite_blocks['donation']['fields']['thank_you_description']['max_length'] ?>" />
        </div>

        <div class="form-group">
            <label for="<?= 'donation_thank_you_url_' . $row->microsite_block_id ?>"><?= l('microsite_donation.thank_you_url') ?></label>
            <input type="url" id="<?= 'donation_thank_you_url_' . $row->microsite_block_id ?>" name="thank_you_url" class="form-control" value="<?= $row->settings->thank_you_url ?? null ?>" maxlength="<?= $data->microsite_blocks['product']['fields']['thank_you_url']['max_length'] ?>" />
            <small class="form-text text-muted"><?= l('microsite_donation.thank_you_url_help') ?></small>
        </div>

        <div class="mb-3">
            <div class="d-flex flex-column flex-xl-row justify-content-between">
                <label for="<?= 'donation_payment_processors_ids_' . $row->microsite_block_id ?>"><?= l('payment_processors.payment_processors_ids') ?></label>
            ...
            <?php foreach($data->payment_processors as $payment_processor): ?>
                <div class="custom-control custom-checkbox my-2">
                    <input id="<?= 'donation_payment_processors_ids' . $payment_processor->payment_processor_id . '_' . $row->microsite_block_id ?>" name="payment_processors_ids[]" value="<?= $payment_processor->payment_processor_id ?>" type="checkbox" class="custom-control-input" <?= in_array($payment_processor->payment_processor_id, $row->settings->payment_processors_ids ?? []) ? 'checked="checked"' : null ?>>
                    <label class="custom-control-label" for="<?= 'donation_payment_processors_ids' . $payment_processor->payment_processor_id . '_' . $row->microsite_block_id ?>">
    ...
    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'donation_data_container_' . $row->microsite_block_id ?>" aria-expanded="false" aria-controls="<?= 'donation_data_container_' . $row->microsite_block_id ?>">
        <i class="fas fa-fw fa-database fa-sm mr-1"></i> <?= l('microsite_block.data_header') ?>
    </button>

    <div class="collapse" id="<?= 'donation_data_container_' . $row->microsite_block_id ?>">
        <div class="alert alert-info">
            <i class="fas fa-fw fa-sm fa-info-circle mr-1"></i> <?= l('microsite_block.data_help') ?>
        </div>

        <div class="form-group">
            <label for="<?= 'donation_email_notification_' . $row->microsite_block_id ?>"><?= l('microsite_block.email_notification') ?></label>
            <input type="text" id="<?= 'donation_email_notification_' . $row->microsite_block_id ?>" name="email_notification" class="form-control" value="<?= $row->settings->email_notification ?? null ?>" placeholder="<?= l('global.email_placeholder') ?>" maxlength="<?= $data->microsite_blocks['donation']['fields']['email_notification']['max_length'] ?>" />
            <small class="form-text text-muted"><?= l('microsite_block.email_notification_help') ?></small>
        </div>

        <div class="form-group">
            <label for="<?= 'donation_webhook_url_' . $row->microsite_block_id ?>"><?= l('microsite_block.webhook_url') ?></label>
            <input type="url" id="<?= 'donation_webhook_url_' . $row->microsite_block_id ?>" name="webhook_url" class="form-control" value="<?= $row->settings->webhook_url ?? null ?>" placeholder="<?= l('global.url_placeholder') ?>" maxlength="<?= $data->microsite_blocks['donation']['fields']['webhook_url']['max_length'] ?>" />
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->microsite_block_id ?>">
        <div class="form-group">
            <label for="<?= 'donation_name_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('microsite_link.name') ?></label>
            <input id="<?= 'donation_name_' . $row->microsite_block_id ?>" type="text" name="name" class="form-control" value="<?= $row->settings->name ?>" maxlength="128" required="required" />
        </div>
        ...
        <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= settings()->links->thumbnail_image_size_limit ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), settings()->links->thumbnail_image_size_limit) ?>">
            <label for="<?= 'donation_image_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-image fa-sm text-muted mr-1"></i> <?= l('microsite_link.image') ?></label>
            <?= include_view(THEME_PATH . 'views/partials/custom_file_image_input.php', [
                'id'=> 'donation_image_' . $row->microsite_block_id,
                'uploads_file_key' => 'block_thumbnail_images',
                'file_key' => 'image',
                'already_existing_image' => $row->settings->image,
                'image_container' => 'image',
                'accept' => \SeeGap\Uploads::array_to_list_format($data->microsite_blocks['donation']['whitelisted_thumbnail_image_extensions']),
            ]) ?>
            <small class="form-text text-muted"><?= sprintf(l('global.accessibility.whitelisted_file_extensions'), \SeeGap\Uploads::array_to_list_format($data->microsite_blocks['donation']['whitelisted_thumbnail_image_extensions'])) . ' ' . sprintf(l('global.accessibility.file_size_limit'), settings()->links->thumbnail_image_size_limit) ?></small>
        </div>

        <div class="form-group">
            <label for="<?= 'donation_icon_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-icons fa-sm text-muted mr-1"></i> <?= l('global.icon') ?></label>
            <input id="<?= 'donation_icon_' . $row->microsite_block_id ?>" type="text" name="icon" class="form-control" value="<?= $row->settings->icon ?>" placeholder="<?= l('global.icon_placeholder') ?>" />
            <small class="form-text text-muted"><?= l('global.icon_help') ?></small>
        </div>

        <div class="form-group">
            <label for="<?= 'donation_text_color_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('microsite_link.text_color') ?></label>
            <input id="<?= 'donation_text_color_' . $row->microsite_block_id ?>" type="hidden" name="text_color" class="form-control" value="<?= $row->settings->text_color ?>" required="required" />
        ...
        <div class="form-group">
            <label for="<?= 'donation_background_color_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('microsite_link.background_color') ?></label>
            <input id="<?= 'donation_background_color_' . $row->microsite_block_id ?>" type="hidden" name="background_color" class="form-control" value="<?= $row->settings->background_color ?>" required="required" />
            <div class="background_color_pickr"></div>
        </div>

        <div class="form-group">
            <label for="<?= 'donation_animation_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-film fa-sm text-muted mr-1"></i> <?= l('microsite_link.animation') ?></label>
            <select id="<?= 'donation_animation_' . $row->microsite_block_id ?>" name="animation" class="custom-select">
        ...
        <div class="form-group" data-animation="<?= implode(',', require APP_PATH . 'includes/microsite_animations.php') ?>">
            <label for="<?= 'donation_animation_runs_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-play-circle fa-sm text-muted mr-1"></i> <?= l('microsite_link.animation_runs') ?></label>
            <select id="<?= 'donation_animation_runs_' . $row->microsite_block_id ?>" name="animation_runs" class="custom-select">
