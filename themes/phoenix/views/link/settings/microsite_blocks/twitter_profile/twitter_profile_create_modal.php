    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('microsite_twitter_profile.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_microsite_twitter_profile" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="twitter_profile_location_url"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('microsite_twitter_profile.location_url') ?></label>
                        <input id="twitter_profile_location_url" type="url" class="form-control" name="location_url" required="required" maxlength="2048" placeholder="<?= l('microsite_twitter_profile.location_url_placeholder') ?>" />
                    </div>

                    <div class="form-group">
                        <label for="twitter_profile_theme"><i class="fas fa-fw fa-sun fa-sm text-muted mr-1"></i> <?= l('microsite_twitter_profile.theme') ?></label>
