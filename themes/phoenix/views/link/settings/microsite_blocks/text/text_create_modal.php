            ...
            <div class="modal-body">
                <form name="create_microsite_text" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label><i class="fas fa-fw fa-heading fa-sm text-muted mr-1"></i> <?= l('microsite_text.title') ?></label>
                        <input type="text" class="form-control" name="title" />
                    </div>

                    <div class="form-group">
                        <label><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('microsite_text.description') ?></label>
