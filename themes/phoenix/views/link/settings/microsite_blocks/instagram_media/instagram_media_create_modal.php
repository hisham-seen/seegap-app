            ...
            <div class="modal-body">
                <form name="create_microsite_instagram_media" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="instagram_media_location_url"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('microsite_instagram_media.location_url') ?></label>
                        <input id="instagram_media_location_url" type="url" class="form-control" name="location_url" required="required" maxlength="2048" placeholder="<?= l('microsite_instagram_media.location_url_placeholder') ?>" />
                    </div>
