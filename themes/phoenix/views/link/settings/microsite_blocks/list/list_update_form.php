...
<form name="update_microsite_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'list_text_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('microsite_list.text') ?></label>
        <textarea id="<?= 'list_text_' . $row->microsite_block_id ?>" class="form-control" name="text" maxlength="2048"><?= $row->settings->text ?></textarea>
        <small class="form-text text-muted"><?= l('microsite_list.text_help') ?></small>
    </div>

    <div class="form-group">
        <label for="<?= 'list_icon_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-icons fa-sm text-muted mr-1"></i> <?= l('global.icon') ?></label>
        <input id="<?= 'list_icon_' . $row->microsite_block_id ?>" type="text" name="icon" class="form-control" value="<?= $row->settings->icon ?>" placeholder="<?= l('global.icon_placeholder') ?>" />
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->microsite_block_id ?>">
        <div class="form-group">
            <label for="<?= 'list_text_color_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('microsite_link.text_color') ?></label>
            <input id="<?= 'list_text_color_' . $row->microsite_block_id ?>" type="hidden" name="text_color" class="form-control" value="<?= $row->settings->text_color ?>" required="required" />
        ...
        <div class="form-group">
            <label for="<?= 'list_background_color_' . $row->microsite_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('microsite_link.background_color') ?></label>
            <input id="<?= 'list_background_color_' . $row->microsite_block_id ?>" type="hidden" name="background_color" class="form-control" value="<?= $row->settings->background_color ?>" required="required" />
    ...
    <div class="form-group">
        <label for="<?= 'margin_items_y' . $row->microsite_block_id ?>"><?= l('microsite_list.margin_items_y') ?></label>
        <input id="<?= 'margin_items_y' . $row->microsite_block_id ?>" type="range" name="margin_items_y" min="0" max="5" step="1" value="<?= $row->settings->margin_items_y ?>" class="form-control-range" />
    </div>

    <div class="form-group">
        <label for="<?= 'margin_items_x' . $row->microsite_block_id ?>"><?= l('microsite_list.margin_items_x') ?></label>
        <input id="<?= 'margin_items_x' . $row->microsite_block_id ?>" type="range" name="margin_items_x" min="0" max="3" step="1" value="<?= $row->settings->margin_items_x ?>" class="form-control-range" />
    </div>
