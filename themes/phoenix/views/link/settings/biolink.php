    ...
    <div class="col-12 col-lg-4">
        <div class="card mb-3 shadow-sm">
            <div class="card-body p-2">
                ...
                <!-- Blocks Content -->
                <div id="biolink_blocks" class="mt-3">
                    <?php if($data->link_links_result->num_rows): ?>
                        <?php while($row = $data->link_links_result->fetch_object()): ?>
                            ...
                            <div class="biolink_block card shadow-sm <?= $row->is_enabled ? null : 'custom-row-inactive' ?> mb-2" data-biolink-block-id="<?= $row->biolink_block_id ?>">
                                <div class="card-body p-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="mr-2 d-none d-lg-block">
                                            <div class="d-flex align-items-center justify-content-center rounded-circle" style="width: 24px; height: 24px; background-color: <?= $data->biolink_blocks[$row->type]['color'] ?>;">
                                                <i class="<?= $data->biolink_blocks[$row->type]['icon'] ?> fa-fw fa-xs text-white"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex flex-column">
                                                <div class="text-truncate">
                                                    ...
                                                    >
                                                        <?= $data->biolink_blocks[$row->type]['display_dynamic_name'] ? ($row->settings->{$data->biolink_blocks[$row->type]['display_dynamic_name']} ? string_truncate($row->settings->{$data->biolink_blocks[$row->type]['display_dynamic_name']}, 20) : l('link.biolink.blocks.' . $row->type)) : l('link.biolink.blocks.' . $row->type) ?>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="ml-2 d-flex align-items-center">
                                            <div class="custom-control custom-switch mr-2" data-toggle="tooltip" title="<?= l('link.biolink_blocks.is_enabled_tooltip') ?>">
                                                <input
                                                        type="checkbox"
            ...
            <div class="card-body p-2">
                ...
                <form id="update_biolink" name="update_biolink" action="" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <?php if(settings()->links->biolinks_themes_is_enabled): ?>
                            ...
                            <div class="form-group mb-2">
                                <label class="small mb-1"><i class="fas fa-fw fa-palette fa-sm text-muted mr-1"></i> <?= l('link.settings.biolink_theme_id') ?></label>

                                <div class="position-relative">
                                    <?php $biolink_socials = require APP_PATH . 'includes/biolink_socials.php'; ?>

                                    <div class="biolink-themes-wrapper-left" style="opacity: 0"></div>
                                    <div class="biolink-themes-wrapper-right" style="opacity: 1"></div>

                                    <div id="biolinks_themes" class="biolink-themes-wrapper d-flex" style="overflow-x: scroll; width: 100%;">
                                        <?php foreach($data->biolinks_themes as $key => $theme): ?>
                                            ...
                                            <label for="settings_biolink_theme_id_<?= $key ?>" class="m-0 col-6 p-2" <?= in_array($theme->biolink_theme_id, $this->user->plan_settings->biolinks_themes ?? []) ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
                                                    ...
                                                    <div class="card-body flex-column d-flex justify-content-center align-items-center text-truncate">
                                                        ...
                                                        <div class="w-100" style="cursor: not-allowed;pointer-events: none;">
                                                            ...
                                                            <div class="text-center text-truncate small mb-2">
                                                                <span style="color: <?= $theme->settings->biolink_block_paragraph->text_color ?? '#ffffff' ?>"><?= l('link.settings.biolink_theme_sample_description') ?></span>
                                                            </div>
                                        ...
                                        <label for="settings_biolink_theme_id_null" class="m-0 col-6 p-2">
