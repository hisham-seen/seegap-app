                    ...
                    <div class="card-body">
                        ...
                        <div class="collapse" id="colors_container" data-parent="#form">
                            ...
                            <div class="form-group" data-foreground-type="gradient">
                                ...
                                <input type="hidden" id="foreground_gradient_one" name="foreground_gradient_one" class="form-control <?= \SeeGap\Alerts::has_field_errors('foreground_gradient_one') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['foreground_gradient_one'] ?? '#000000' ?>" data-reload-qr-code data-color-picker />
                                <?= \SeeGap\Alerts::output_field_error('foreground_gradient_one') ?>
                            </div>
                            ...
                            <div class="form-group" data-foreground-type="gradient">
                                ...
                                <input type="hidden" id="foreground_gradient_two" name="foreground_gradient_two" class="form-control <?= \SeeGap\Alerts::has_field_errors('foreground_gradient_two') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['foreground_gradient_two'] ?? '#000000' ?>" data-reload-qr-code data-color-picker />
                                <?= \SeeGap\Alerts::output_field_error('foreground_gradient_two') ?>
                            </div>
                            ...
                            <div class="form-group" data-range-counter data-range-counter-suffix="%">
                                ...
                                <input id="background_color_transparency" type="range" min="0" max="100" step="5" name="background_color_transparency" value="<?= $data->values['settings']['background_color_transparency'] ?? 0 ?>" class="form-control-range <?= \SeeGap\Alerts::has_field_errors('background_color_transparency') ? 'is-invalid' : null ?>" data-reload-qr-code />
                                <?= \SeeGap\Alerts::output_field_error('background_color_transparency') ?>
                            </div>
                            ...
                            <div class="form-group" data-custom-eyes-color="on">
                                ...
                                <input type="hidden" id="eyes_inner_color" name="eyes_inner_color" class="form-control <?= \SeeGap\Alerts::has_field_errors('eyes_inner_color') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['eyes_inner_color'] ?? '#000000' ?>" data-reload-qr-code data-color-picker />
                                <?= \SeeGap\Alerts::output_field_error('eyes_inner_color') ?>
                            </div>
                        ...
                        <div class="collapse" id="frame_container" data-parent="#form">
                            ...
                            <div class="form-group" data-range-counter>
                                ...
                                <input id="frame_text_size" type="range" min="-5" max="5" name="frame_text_size" value="<?= $data->values['settings']['frame_text_size'] ?>" class="form-control-range <?= \SeeGap\Alerts::has_field_errors('frame_text_size') ? 'is-invalid' : null ?>" data-reload-qr-code />
                                <?= \SeeGap\Alerts::output_field_error('frame_text_size') ?>
                            </div>
                            ...
                            <div class="form-group" data-frame-custom-colors="on">
                                ...
                                <input type="hidden" id="frame_color" name="frame_color" class="form-control <?= \SeeGap\Alerts::has_field_errors('frame_color') ? 'is-invalid' : null ?>" value="<?= $data->values['settings']['frame_color'] ?>" data-reload-qr-code data-color-picker />
                                <?= \SeeGap\Alerts::output_field_error('frame_color') ?>
                            </div>
                        ...
                        <div class="collapse" id="branding_container" data-parent="#form">
                            ...
                            <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= settings()->codes->background_size_limit ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), settings()->codes->background_size_limit) ?>">
                                ...
                                <?= \SeeGap\Alerts::output_field_error('qr_code_background') ?>
                                <small class="form-text text-muted"><?= sprintf(l('global.accessibility.whitelisted_file_extensions'), \SeeGap\Uploads::get_whitelisted_file_extensions_accept('qr_code_background')) . ' ' . sprintf(l('global.accessibility.file_size_limit'), settings()->codes->background_size_limit) ?></small>
                            </div>
                            ...
                            <div class="form-group" data-range-counter data-range-counter-suffix="%">
                                ...
                                <input id="qr_code_background_transparency" type="range" min="0" max="95" step="5" name="qr_code_background_transparency" value="<?= $data->values['settings']['qr_code_background_transparency'] ?? 0 ?>" class="form-control-range <?= \SeeGap\Alerts::has_field_errors('qr_code_background_transparency') ? 'is-invalid' : null ?>" data-reload-qr-code />
                                <?= \SeeGap\Alerts::output_field_error('qr_code_background_transparency') ?>
                            </div>
                            ...
                            <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= settings()->codes->background_size_limit ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), settings()->codes->background_size_limit) ?>">
                                ...
                                <?= \SeeGap\Alerts::output_field_error('qr_code_foreground') ?>
                                <small class="form-text text-muted"><?= sprintf(l('global.accessibility.whitelisted_file_extensions'), \SeeGap\Uploads::get_whitelisted_file_extensions_accept('qr_code_foreground')) . ' ' . sprintf(l('global.accessibility.file_size_limit'), settings()->codes->background_size_limit) ?></small>
                            </div>
