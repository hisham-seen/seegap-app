            ...
            <form action="" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div <?= $this->user->plan_settings->white_labeling_is_enabled ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
                            <div class="<?= $this->user->plan_settings->white_labeling_is_enabled ? null : 'container-disabled' ?>">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="white_label_title" name="white_label_title" class="form-control <?= \SeeGap\Alerts::has_field_errors('white_label_title') ? 'is-invalid' : null ?>" value="<?= $this->user->preferences->white_label_title ?>" maxlength="32" />
                                    <?= \SeeGap\Alerts::output_field_error('white_label_title') ?>
                                </div>
                                ...
                                <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= get_max_upload() ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), get_max_upload()) ?>">
                                    ...
                                    <small class="form-text text-muted"><?= sprintf(l('global.accessibility.whitelisted_file_extensions'), \SeeGap\Uploads::get_whitelisted_file_extensions_accept('users')) . ' ' . sprintf(l('global.accessibility.file_size_limit'), get_max_upload()) ?></small>
                                </div>
                ...
                <div class="collapse" id="default_settings_container">
                    <div class="form-group">
                        ...
                        <select id="default_results_per_page" name="default_results_per_page" class="custom-select <?= \SeeGap\Alerts::has_field_errors('default_results_per_page') ? 'is-invalid' : null ?>">
                        ...
                        <?= \SeeGap\Alerts::output_field_error('default_results_per_page') ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="default_order_type" name="default_order_type" class="custom-select <?= \SeeGap\Alerts::has_field_errors('default_order_type') ? 'is-invalid' : null ?>">
                        ...
                        <?= \SeeGap\Alerts::output_field_error('default_order_type') ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="links_default_order_by" name="links_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('links_default_order_by') ? 'is-invalid' : null ?>">
                        ...
                        <?= \SeeGap\Alerts::output_field_error('links_default_order_by') ?>
                    </div>
                    ...
                    <?php if(settings()->codes->qr_codes_is_enabled): ?>
                        <div class="form-group">
                            ...
                            <select id="qr_codes_default_order_by" name="qr_codes_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('qr_codes_default_order_by') ? 'is-invalid' : null ?>">
                            ...
                            <?= \SeeGap\Alerts::output_field_error('qr_codes_default_order_by') ?>
                        </div>
                    <?php endif ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="projects_default_order_by" name="projects_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('projects_default_order_by') ? 'is-invalid' : null ?>">
                        ...
                        <?= \SeeGap\Alerts::output_field_error('projects_default_order_by') ?>
                    </div>
                    <?php endif ?>
                    ...
                    <?php if(settings()->links->pixels_is_enabled): ?>
                        <div class="form-group">
                            ...
                            <select id="pixels_default_order_by" name="pixels_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('pixels_default_order_by') ? 'is-invalid' : null ?>">
                            ...
                            <?= \SeeGap\Alerts::output_field_error('pixels_default_order_by') ?>
                        </div>
                    <?php endif ?>
                    ...
                    <?php if(settings()->links->domains_is_enabled): ?>
                        <div class="form-group">
                            ...
                            <select id="domains_default_order_by" name="domains_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('domains_default_order_by') ? 'is-invalid' : null ?>">
                            ...
                            <?= \SeeGap\Alerts::output_field_error('domains_default_order_by') ?>
                        </div>
                    <?php endif ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="splash_pages_default_order_by" name="splash_pages_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('splash_pages_default_order_by') ? 'is-invalid' : null ?>">
                        ...
                        <?= \SeeGap\Alerts::output_field_error('splash_pages_default_order_by') ?>
                    </div>
                    <?php endif ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="data_default_order_by" name="data_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('data_default_order_by') ? 'is-invalid' : null ?>">
                        ...
                        <?= \SeeGap\Alerts::output_field_error('data_default_order_by') ?>
                    </div>
                    ...
                    <?php if(\SeeGap\Plugin::is_active('payment-blocks')): ?>
                        <div class="form-group">
                            ...
                            <select id="payment_processors_default_order_by" name="payment_processors_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('payment_processors_default_order_by') ? 'is-invalid' : null ?>">
                            ...
                            <?= \SeeGap\Alerts::output_field_error('payment_processors_default_order_by') ?>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="guests_payments_default_order_by" name="guests_payments_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('guests_payments_default_order_by') ? 'is-invalid' : null ?>">
                            ...
                            <?= \SeeGap\Alerts::output_field_error('guests_payments_default_order_by') ?>
                        </div>
                    <?php endif ?>
                    ...
                    <?php if(\SeeGap\Plugin::is_active('email-signatures') && settings()->signatures->is_enabled): ?>
                        <div class="form-group">
                            ...
                            <select id="signatures_default_order_by" name="signatures_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('signatures_default_order_by') ? 'is-invalid' : null ?>">
                            ...
                            <?= \SeeGap\Alerts::output_field_error('signatures_default_order_by') ?>
                        </div>
                    <?php endif ?>
                    ...
                    <?php if(\SeeGap\Plugin::is_active('aix') && settings()->aix->documents_is_enabled): ?>
                        <div class="form-group">
                            ...
                            <select id="documents_default_order_by" name="documents_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('documents_default_order_by') ? 'is-invalid' : null ?>">
                            ...
                            <?= \SeeGap\Alerts::output_field_error('documents_default_order_by') ?>
                        </div>
                    <?php endif ?>
                    ...
                    <?php if(\SeeGap\Plugin::is_active('aix') && settings()->aix->images_is_enabled): ?>
                        <div class="form-group">
                            ...
                            <select id="images_default_order_by" name="images_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('images_default_order_by') ? 'is-invalid' : null ?>">
                            ...
                            <?= \SeeGap\Alerts::output_field_error('images_default_order_by') ?>
                        </div>
                    <?php endif ?>
                    ...
                    <?php if(\SeeGap\Plugin::is_active('aix') && settings()->aix->transcriptions_is_enabled): ?>
                        <div class="form-group">
                            ...
                            <select id="transcriptions_default_order_by" name="transcriptions_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('transcriptions_default_order_by') ? 'is-invalid' : null ?>">
                            ...
                            <?= \SeeGap\Alerts::output_field_error('transcriptions_default_order_by') ?>
                        </div>
                    <?php endif ?>
                    ...
                    <?php if(\SeeGap\Plugin::is_active('aix') && settings()->aix->chats_is_enabled): ?>
                        <div class="form-group">
                            ...
                            <select id="chats_default_order_by" name="chats_default_order_by" class="custom-select <?= \SeeGap\Alerts::has_field_errors('chats_default_order_by') ? 'is-invalid' : null ?>">
                            ...
                            <?= \SeeGap\Alerts::output_field_error('chats_default_order_by') ?>
                        </div>
                    <?php endif ?>
