...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="custom-breadcrumbs small">
            ...
            <li class="active" aria-current="page"><?= l('gs1_link_create.breadcrumb') ?></li>
        </ol>
    </nav>

    <div class="row mb-4">
        <div class="col-12 col-lg d-flex align-items-center mb-3 mb-lg-0 text-truncate">
            <h1 class="h4 m-0 text-truncate"><i class="fas fa-fw fa-plus-circle mr-1"></i> <?= l('gs1_link_create.header') ?></h1>
        </div>
    </div>
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="gtin" name="gtin" class="form-control <?= \Altum\Alerts::has_field_errors('gtin') ? 'is-invalid' : null ?>" value="<?= $data['values']['gtin'] ?? null ?>" placeholder="<?= l('gs1_links.input.gtin_placeholder') ?>" required="required" />
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="target_url" name="target_url" class="form-control <?= \Altum\Alerts::has_field_errors('target_url') ? 'is-invalid' : null ?>" value="<?= $data['values']['target_url'] ?? null ?>" placeholder="<?= l('global.url_placeholder') ?>" required="required" />
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" class="form-control" value="<?= $data['values']['title'] ?? null ?>" maxlength="256" />
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-control" rows="3"><?= $data['values']['description'] ?? null ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select id="domain_id" name="domain_id" class="custom-select">
                            ...
                            <?php foreach($data['domains'] as $row): ?>
                                <option value="<?= $row->domain_id ?>" <?= $data['values']['domain_id'] ?? null == $row->domain_id ? 'selected="selected"' : null ?>><?= $row->host ?></option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="pixels_ids" name="pixels_ids[]" class="custom-select" multiple="multiple">
                            <?php foreach($data['pixels'] as $row): ?>
                                <option value="<?= $row->pixel_id ?>" <?= in_array($row->pixel_id, $data['values']['pixels_ids'] ?? []) ? 'selected="selected"' : null ?>><?= $row->name ?></option>
                            <?php endforeach ?>
                        </select>
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="utm_source" name="utm_source" class="form-control" value="<?= $data['values']['utm_source'] ?? null ?>" />
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="utm_medium" name="utm_medium" class="form-control" value="<?= $data['values']['utm_medium'] ?? null ?>" />
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="utm_campaign" name="utm_campaign" class="form-control" value="<?= $data['values']['utm_campaign'] ?? null ?>" />
