...
<div class="container-fluid">
    ...
    <h1 class="h4 text-truncate mb-4"><i class="fas fa-fw fa-xs fa-barcode mr-1"></i> <?= l('gs1_link_create.header') ?></h1>

    <div class="row gs1-link-create">
        ...
        <div class="col-12 col-lg-4">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <form action="" method="post" role="form" id="gs1_link_create_form">
                <input type="hidden" name="token" value="<?= \Altum\Csrf::get() ?>" />

                <div class="form-group">
                    <label for="gtin"><i class="fas fa-fw fa-sm fa-barcode text-muted mr-1"></i> <?= l('gs1_links.input.gtin') ?></label>
                    <input type="text" id="gtin" name="gtin" class="form-control <?= \Altum\Alerts::has_field_errors('gtin') ? 'is-invalid' : null ?>" value="<?= $data->values['gtin'] ?>" maxlength="14" placeholder="<?= l('gs1_links.input.gtin_placeholder') ?>" required="required" />
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="target_url" name="target_url" class="form-control <?= \Altum\Alerts::has_field_errors('target_url') ? 'is-invalid' : null ?>" value="<?= $data->values['target_url'] ?>" maxlength="2048" placeholder="<?= l('global.url_placeholder') ?>" required="required" />
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="gs1-flow-visualization">
                        ...
                        <div class="flow-step">
                            ...
                            <div class="flow-content">
                                ...
                                <small class="text-muted">
                                    <span id="flow_gs1_url"><?= l('gs1_link_create.flow_step_gs1_description') ?></span>
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="flow-step" id="flow_targeting_step" style="display: none;">
                            <div class="flow-icon">
                        ...
                        <div class="flow-arrow" id="flow_targeting_arrow" style="display: none;">
                            <i class="fas fa-arrow-down text-muted"></i>
                        </div>
                        ...
                        <div class="flow-step">
                            ...
                            <div class="flow-content">
                                ...
                                <small class="text-muted">
                                    <span id="flow_destination_url"><?= l('gs1_link_create.flow_step_destination_description') ?></span>
                                </small>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="mt-4">
                                                <div class="preview-url-display p-2 bg-light rounded">
                                                    <small class="text-muted">
                                                        ...
                                                        <span id="preview_final_url"><?= l('gs1_link_create.preview_url_placeholder') ?></span>
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
