                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div id="biolinks_themes" class="biolink-themes-wrapper d-flex" style="overflow-x: scroll; width: 100%;">
                                                <?php foreach($data->biolinks_themes as $key => $theme): ?>
                                                    ...
                                                    <label for="settings_biolink_theme_id_<?= $key ?>" class="m-0 col-6 p-3" <?= in_array($theme->biolink_theme_id, $this->user->plan_settings->biolinks_themes ?? []) ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
                                                ...
                                                <label for="settings_biolink_theme_id_null" class="m-0 col-6 p-3">
