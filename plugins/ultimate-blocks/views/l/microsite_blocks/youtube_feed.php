...
<div id="<?= 'microsite_block_id_' . $data->link->microsite_block_id ?>" data-microsite-block-id="<?= $data->link->microsite_block_id ?>" data-microsite-block-type="<?= $data->link->type ?>" class="col-12">
    <?php

    /* Caching */
    $cache_instance = cache()->getItem('microsite_block?block_id=' . $data->link->microsite_block_id . '&type=youtube_feed');
