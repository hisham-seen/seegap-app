...
<?php ob_start() ?>
<div class="modal fade" id="<?= 'coupon_' . $data->link->biolink_block_id ?>" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="card border-gray-200 rounded-2x">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <span class="font-weight-bold" id="<?= 'coupon_' . $data->link->biolink_block_id ?>"><?= $data->link->settings->coupon ?></span>
                        ...
                        <div>
                            <button
                                    ...
                                    data-clipboard-target="#<?= 'coupon_' . $data->link->biolink_block_id ?>"
                            >
