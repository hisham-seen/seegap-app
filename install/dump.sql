...
CREATE TABLE `products` (
  ...
  `net_weight` varchar(32) DEFAULT NULL COMMENT 'GS1 AI 310n - Net Weight (kg)',
  `dimensions` varchar(64) DEFAULT NULL COMMENT 'Length x Width x Height',
  `ingredients` text,
  ...
  `gs1_link_enabled` TINYINT(1) DEFAULT 0 COMMENT 'Enable GS1 Digital Link functionality',
  `gs1_link_type` VARCHAR(32) DEFAULT 'custom' COMMENT 'Type of GS1 link (custom, microsite, link, file, etc.)',
  `gs1_target_url` TEXT COMMENT 'Target URL for GS1 Digital Link',
  `gs1_existing_content_id` INT(11) NULL COMMENT 'ID of existing content to link to',
  `gs1_link_title` VARCHAR(128) DEFAULT '' COMMENT 'Title for GS1 Digital Link',
  `gs1_link_description` TEXT COMMENT 'Description for GS1 Digital Link',
  `auto_generate_qr` TINYINT(1) DEFAULT 0 COMMENT 'Auto-generate QR code for this product',
  `qr_code_size` VARCHAR(10) DEFAULT '500' COMMENT 'QR code size in pixels',
  `qr_code_ecc` VARCHAR(5) DEFAULT 'M' COMMENT 'QR code error correction level',
  `gs1_schedule_enabled` TINYINT(1) DEFAULT 0 COMMENT 'Enable scheduling for GS1 link',
  `gs1_start_date` DATETIME NULL COMMENT 'GS1 link start date',
  `gs1_end_date` DATETIME NULL COMMENT 'GS1 link end date',
  `gs1_clicks_limit` INT(11) NULL COMMENT 'Maximum clicks allowed for GS1 link',
  `gs1_expiration_url` TEXT COMMENT 'URL to redirect to when GS1 link expires',
  `gs1_utm_source` VARCHAR(128) DEFAULT '' COMMENT 'UTM source parameter for GS1 link',
  `gs1_utm_medium` VARCHAR(128) DEFAULT '' COMMENT 'UTM medium parameter for GS1 link',
  `gs1_utm_campaign` VARCHAR(128) DEFAULT '' COMMENT 'UTM campaign parameter for GS1 link',
  -- GS1 Identifiers (AI codes)
  `gln` varchar(13) DEFAULT NULL COMMENT 'GS1 AI 413 - Global Location Number',
  `variant` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 20 - Variant Number',
  `batch_lot_number` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 10 - Batch/Lot Number',
  `serial` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 21 - Serial Number',
  `cpid` varchar(30) DEFAULT NULL COMMENT 'GS1 AI 8010 - Component/Part Identifier',
  `additional_id` varchar(30) DEFAULT NULL COMMENT 'Additional product identifier',
  ...
  `packaging_date` date DEFAULT NULL COMMENT 'GS1 AI 13 - Pack Date (YYMMDD)',
  ...
  `expiration_date` date DEFAULT NULL COMMENT 'GS1 AI 17 - Use By Date (YYMMDD)',
  ...
  `reference_to_source` varchar(30) DEFAULT NULL COMMENT 'GS1 AI 251 - Reference to Source Entity',
  `global_document_type_id` varchar(30) DEFAULT NULL COMMENT 'GS1 AI 253 - Global Document Type Identifier',
  -- GS1 Measurements (variable measures)
  `net_weight_kg` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 310n - Net Weight (kg)',
  `length_m` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 311n - Length (m)',
  `width_m` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 312n - Width (m)',
  `height_m` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 313n - Height (m)',
  `area_m2` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 314n - Area (m²)',
  `net_volume_l` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 315n - Net Volume (L)',
  `gross_weight_kg` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 330n - Gross Weight (kg)',
  `logistic_weight_kg` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 331n - Logistic Weight (kg)',
  `logistic_length_m` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 332n - Logistic Length (m)',
  `logistic_width_m` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 333n - Logistic Width (m)',
  `logistic_height_m` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 334n - Logistic Height (m)',
  `logistic_area_m2` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 335n - Logistic Area (m²)',
  `logistic_volume_l` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 336n - Logistic Volume (L)',
  -- GS1 Logistics
  `ship_to_loc` varchar(13) DEFAULT NULL COMMENT 'GS1 AI 410 - Ship To Location GLN',
  `bill_to` varchar(13) DEFAULT NULL COMMENT 'GS1 AI 411 - Bill To Location GLN',
  `purchased_from` varchar(13) DEFAULT NULL COMMENT 'GS1 AI 412 - Purchase From Location GLN',
  `ship_for_loc` varchar(13) DEFAULT NULL COMMENT 'GS1 AI 413 - Ship For Location GLN',
  `phy_loc` varchar(13) DEFAULT NULL COMMENT 'GS1 AI 414 - Physical Location GLN',
  `rti_loc` varchar(13) DEFAULT NULL COMMENT 'GS1 AI 415 - RTI Location GLN',
  `ship_to_post` varchar(20) DEFAULT NULL COMMENT 'GS1 AI 420 - Ship To Postal Code',
  `ship_to_post_iso` varchar(3) DEFAULT NULL COMMENT 'GS1 AI 421 - Ship To Postal Code ISO',
  `origin` varchar(3) DEFAULT NULL COMMENT 'GS1 AI 422 - Country of Origin',
  `country_initial_process` varchar(3) DEFAULT NULL COMMENT 'GS1 AI 423 - Country of Initial Processing',
  `country_process` varchar(3) DEFAULT NULL COMMENT 'GS1 AI 424 - Country of Processing',
  `country_disassembly` varchar(3) DEFAULT NULL COMMENT 'GS1 AI 425 - Country of Disassembly',
  `country_full_process` varchar(3) DEFAULT NULL COMMENT 'GS1 AI 426 - Country of Full Process',
  -- Content & Compliance
  `organic_certification` varchar(64) DEFAULT NULL COMMENT 'Organic certification details',
  `fair_trade_certification` varchar(64) DEFAULT NULL COMMENT 'Fair trade certification details',
  `halal_certified` TINYINT(1) DEFAULT 0 COMMENT 'Halal certification status',
  `kosher_certified` TINYINT(1) DEFAULT 0 COMMENT 'Kosher certification status',
  `gluten_free` TINYINT(1) DEFAULT 0 COMMENT 'Gluten-free status',
  `vegan` TINYINT(1) DEFAULT 0 COMMENT 'Vegan status',
  `vegetarian` TINYINT(1) DEFAULT 0 COMMENT 'Vegetarian status',
  `non_gmo` TINYINT(1) DEFAULT 0 COMMENT 'Non-GMO status',
  `care_instructions` TEXT COMMENT 'Care and maintenance instructions',
  `warning_info` TEXT COMMENT 'Warning and safety information',
  -- Digital Integration
  `product_url` text DEFAULT NULL COMMENT 'Official product URL',
  `manufacturer_url` text DEFAULT NULL COMMENT 'Manufacturer website URL',
  `product_info_url` text DEFAULT NULL COMMENT 'Product information URL',
  `sustainability_url` text DEFAULT NULL COMMENT 'Sustainability information URL',
  `recycling_url` text DEFAULT NULL COMMENT 'Recycling information URL',
  `safety_url` text DEFAULT NULL COMMENT 'Safety information URL',
  `facebook_url` text DEFAULT NULL COMMENT 'Facebook page URL',
  `instagram_url` text DEFAULT NULL COMMENT 'Instagram page URL',
  `twitter_url` text DEFAULT NULL COMMENT 'Twitter/X page URL',
  `youtube_url` text DEFAULT NULL COMMENT 'YouTube channel URL',
  `purchase_url` text DEFAULT NULL COMMENT 'Purchase/buy now URL',
  `amazon_asin` varchar(20) DEFAULT NULL COMMENT 'Amazon ASIN identifier',
  `ebay_item_id` varchar(30) DEFAULT NULL COMMENT 'eBay item identifier',
  `price_comparison_url` text DEFAULT NULL COMMENT 'Price comparison URL',
  `manual_url` text DEFAULT NULL COMMENT 'User manual URL',
  `support_url` text DEFAULT NULL COMMENT 'Customer support URL',
  `faq_url` text DEFAULT NULL COMMENT 'FAQ page URL',
  `tutorial_url` text DEFAULT NULL COMMENT 'Tutorial/how-to URL',
  `api_endpoint` text DEFAULT NULL COMMENT 'API endpoint for product data',
  `webhook_url` text DEFAULT NULL COMMENT 'Webhook URL for notifications',
  -- Media & Images
  `youtube_video_id` varchar(20) DEFAULT NULL COMMENT 'YouTube video ID for product demo',
  `image_quality` varchar(20) DEFAULT 'high' COMMENT 'Image quality setting',
  `auto_resize_images` TINYINT(1) DEFAULT 0 COMMENT 'Auto-resize uploaded images',
  `generate_thumbnails` TINYINT(1) DEFAULT 0 COMMENT 'Generate image thumbnails',
  `watermark_images` TINYINT(1) DEFAULT 0 COMMENT 'Add watermark to images',
  -- GS1 Digital Passport Fields - Sustainability Information
  `carbon_footprint` DECIMAL(10,2) NULL COMMENT 'Carbon footprint in kg CO2e',
  `water_usage` DECIMAL(10,2) NULL COMMENT 'Water usage in liters',
  `renewable_energy_percentage` INT(3) NULL COMMENT 'Renewable energy percentage (0-100)',
  `recyclability_score` VARCHAR(32) DEFAULT '' COMMENT 'Recyclability score or rating',
  `sustainability_certifications` TEXT NULL COMMENT 'Sustainability certifications (comma-separated)',
  -- Supply Chain & Traceability
  `supply_chain_transparency` VARCHAR(64) DEFAULT '' COMMENT 'Supply chain transparency level',
  `ethical_sourcing` VARCHAR(64) DEFAULT '' COMMENT 'Ethical sourcing status',
  `key_suppliers` TEXT NULL COMMENT 'Key suppliers information',
  `blockchain_verified` TINYINT(1) DEFAULT 0 COMMENT 'Blockchain verification status',
  -- Compliance & Safety
  `regulatory_compliance` TEXT NULL COMMENT 'Regulatory compliance information',
  `safety_standards` TEXT NULL COMMENT 'Safety standards information',
  `quality_certifications` TEXT NULL COMMENT 'Quality certifications',
  -- Product Lifecycle
  `lifecycle_stage` VARCHAR(32) DEFAULT '' COMMENT 'Current lifecycle stage',
  `expected_lifespan` INT(11) NULL COMMENT 'Expected lifespan value',
  `lifespan_unit` VARCHAR(20) DEFAULT 'years' COMMENT 'Lifespan unit',
  `end_of_life_instructions` TEXT NULL COMMENT 'End of life disposal instructions',
  -- Digital Passport Settings
  `passport_public` TINYINT(1) DEFAULT 0 COMMENT 'Make digital passport public',
  `passport_seo` TINYINT(1) DEFAULT 0 COMMENT 'Include in search engines',
  `passport_last_updated` DATETIME NULL COMMENT 'Last passport update timestamp',
  `data_verification_status` VARCHAR(32) DEFAULT 'unverified' COMMENT 'Data verification status',
  `settings` text,
  `is_enabled` tinyint NOT NULL DEFAULT '1',
  `datetime` datetime NOT NULL,
  `last_datetime` datetime DEFAULT NULL,
  ...
  KEY `idx_products_gs1_link_enabled` (`gs1_link_enabled`),
  KEY `idx_products_gs1_link_type` (`gs1_link_type`),
  KEY `idx_products_auto_generate_qr` (`auto_generate_qr`),
  KEY `idx_products_gs1_schedule_enabled` (`gs1_schedule_enabled`),
  KEY `idx_products_passport_public` (`passport_public`),
  KEY `idx_products_gln` (`gln`),
  KEY `idx_products_batch_lot_number` (`batch_lot_number`),
  KEY `idx_products_serial` (`serial`),
  KEY `idx_products_production_date` (`production_date`),
  KEY `idx_products_best_before` (`best_before_date`),
  KEY `idx_products_variant` (`variant`),
  KEY `idx_products_ship_to_loc` (`ship_to_loc`),
  KEY `idx_products_bill_to` (`bill_to`),
...
CREATE TABLE `gs1_links_statistics` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `gs1_link_id` int(11) NOT NULL,
  `ip` varchar(45) NOT NULL,
  `country_code` varchar(2) DEFAULT NULL,
  `referrer` text DEFAULT NULL,
  `user_agent` text DEFAULT NULL,
  `type` enum('click','page_view','share','qr_scan') DEFAULT 'click',
  `datetime` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `gs1_link_id` (`gs1_link_id`),
  KEY `datetime` (`datetime`),
  KEY `type` (`type`),
  CONSTRAINT `gs1_links_statistics_ibfk_1` FOREIGN KEY (`gs1_link_id`) REFERENCES `gs1_links` (`gs1_link_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `products` (`user_id`, `project_id`, `gtin`, `brand_name`, `product_name`, `product_description`, `category`, `subcategory`, `manufacturer`, `country_of_origin`, `net_weight`, `dimensions`, `ingredients`, `nutritional_info`, `allergen_info`, `certifications`, `product_images`, `packaging_info`, `storage_instructions`, `usage_instructions`, `target_url`, `batch_lot_number`, `serial`, `production_date`, `best_before_date`, `expiration_date`, `sell_by_date`, `packaging_date`, `variant`, `settings`, `is_enabled`, `datetime`) VALUES
