...
(NULL, 'https://Seegap.com/', 'Software by SeeGap', '', '', 'external', 'bottom', 1, 0, NOW(), NOW()),
(NULL, 'https://Seegap.com/66microsites', 'Built with 66microsites', '', '', 'external', 'bottom', 0, 0, NOW(), NOW());
...
INSERT INTO `microsites_blocks` (`user_id`, `link_id`, `type`, `location_url`, `clicks`, `settings`, `order`, `start_date`, `end_date`, `is_enabled`, `datetime`) VALUES (1, 1, 'heading', NULL, 0, '{\"heading_type\":\"h1\",\"text\":\"Example page\",\"text_color\":\"white\"}', 0, NULL, NULL, 1, '2021-12-20 18:05:52');
